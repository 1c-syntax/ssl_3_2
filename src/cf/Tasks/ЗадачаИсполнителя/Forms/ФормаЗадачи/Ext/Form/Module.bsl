...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.НапоминанияПользователя") Тогда
		...
		ПараметрыРазмещения.Группа = Элементы.ГруппаСрокИсполнения;
...
Процедура ЗаписатьЗадачу(Команда)
	...
	БизнесПроцессыИЗадачиКлиент.ЗаписатьЗадачу(ЭтотОбъект);
...
Процедура Выполнено(Команда)
	...
	Если Объект.Выполнена И Не ЗначениеЗаполнено(Объект.ДатаИсполнения) Тогда
		Объект.ДатаИсполнения = ОбщегоНазначенияКлиент.ДатаСеанса();
	КонецЕсли;
...
Процедура ИнициализироватьФорму()
	...
	Если ЗначениеЗаполнено(Объект.БизнесПроцесс) Тогда
		...
		Элементы.ФормаВыполнено.Доступность = НЕ ЕстьФормаЗадачи;
	Иначе
	...
	Если НачальныйПризнакВыполнения Тогда
		Элементы.ФормаВыполнено.Доступность = Ложь;
	Иначе
		Элементы.ФормаВыполнено.Доступность = ПравоДоступа("Изменение", Метаданные.Задачи.ЗадачаИсполнителя);
	КонецЕсли;
