...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		Если ИспользоватьПодчиненныеБизнесПроцессы Тогда
			СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(КоманднаяПанель, Элементы.ДеревоЗадач.КоманднаяПанель);
		Иначе
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ПодключаемыеКоманды") Тогда
		...
		ПараметрыРазмещения.КоманднаяПанель = ?(ИспользоватьПодчиненныеБизнесПроцессы, 
			Элементы.КомандыФормы, Элементы.Список.КоманднаяПанель);
			
		ПараметрыРазмещения.КоманднаяПанель = ?(ИспользоватьПодчиненныеБизнесПроцессы, 
			Элементы.ДеревоЗадачКоманднаяПанель, Элементы.СписокКоманднаяПанель);
...
&НаКлиенте
Процедура ДеревоЗадачПриНаведении(Элемент, Строка, Поле)
...
Процедура УстановитьУсловноеОформление()
	...
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных("СрокИсполнения");
