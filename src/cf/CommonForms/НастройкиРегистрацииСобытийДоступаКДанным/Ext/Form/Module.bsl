...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(КоманднаяПанель,
		Элементы.Настройки.КоманднаяПанель);
	
	// Корректировка порядка команд в командной панели списка.
	СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппе(Элементы.Настройки.КоманднаяПанель,
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"НастройкиУдалить", "ПоложениеВКоманднойПанели", Положение);
...
Процедура НастройкиПриАктивизацииСтроки(Элемент)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"НастройкиКонтекстноеМенюУдалить", "Доступность", УдалениеДоступно);
	КонецЕсли;
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"НастройкиУдалить", "Доступность", УдалениеДоступно);
...
Процедура НастройкиПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	Отказ = Истина;
	ПодключитьОбработчикОжидания("НастройкиВыбрать", 0.1, Истина);
...
&НаКлиенте
Процедура НастройкиПриНаведении(Элемент, Строка, Поле)
	
	ТекущиеДанные = ?(Строка = Неопределено, Элемент.ТекущиеДанные,
		Элемент.ДанныеСтроки(Строка));
	
	УдалениеДоступно = ТекущиеДанные <> Неопределено
		И ТекущиеДанные.ЭтоТаблица;
...
&НаКлиенте
Процедура НастройкиВыбрать(Команда)
