...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.МашиночитаемыеДоверенности") Тогда
		...
		Если Параметры.СвойстваПодписи.Свойство("МашиночитаемаяДоверенность")
			И ЗначениеЗаполнено(Параметры.СвойстваПодписи.МашиночитаемаяДоверенность) Тогда
			...
			ПараметрыСообщения.Идентификатор = "МашиночитаемаяДоверенностьПодписи";
			ПараметрыСообщения.КраткоеПредставление = НСтр("ru='Сведения о МЧД'");
			ПараметрыСообщения.Сообщение = Параметры.СвойстваПодписи.МашиночитаемаяДоверенность;
			ОбщегоНазначения.ДобавитьВажноеСообщение(ЭтотОбъект, ПараметрыСообщения);
			
			МодульМашиночитаемыеДоверенностиФНССлужебный.ЗаполнитьПротоколПроверки(ЭтотОбъект, Элементы.ГруппаМЧД,
	...
	ПараметрыСообщения = ОбщегоНазначения.ПараметрыВажногоСообщения();
	ПараметрыСообщения.ТипСообщения = "Информация";
	ПараметрыСообщения.Идентификатор = "СтатусПроверкиПодписи";
	ПараметрыСообщения.КраткоеПредставление = НСтр("ru='Результат проверки подписи'");
	Если ЗначениеЗаполнено(Статус) Тогда
		ПараметрыСообщения.Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
