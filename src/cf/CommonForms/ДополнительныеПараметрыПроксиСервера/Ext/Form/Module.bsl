...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.НастройкаПроксиНаКлиенте
		...
		ВызватьИсключение(НСтр("ru = 'Недостаточно прав доступа.
			|Дополнительные настройки прокси-сервера выполняются администратором.'"),
	...
	ПараметрыСообщения.Сообщение  = НСтр("ru = 'Адрес сервера может включать символы ""*"" - произвольные символы,  и ""?"" - любой одиночный символ.'");
	ПараметрыСообщения.ТипСообщения = "Информация";
	ПараметрыСообщения.Идентификатор = "ДополнительныеПараметрыПроксиСервера";
	
	ОбщегоНазначения.ВставитьВажноеСообщение(ЭтотОбъект, ПараметрыСообщения, Элементы.ГруппаАдресовИсключений, Элементы.АдресаИсключений);
