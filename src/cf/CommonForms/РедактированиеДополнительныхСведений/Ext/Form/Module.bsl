...
&НаКлиенте
Процедура ТаблицаЗначенийСвойствПриНаведении(Элемент, Строка, Поле)
	Если ТипЗнч(Поле) = Тип("ПолеФормы") Тогда
		ДанныеСтроки = ТаблицаЗначенийСвойств.Получить(Строка);
		Элемент.ПодчиненныеЭлементы.ТаблицаЗначенийСвойствЗначение.ОграничениеТипа = ДанныеСтроки.ТипЗначения;
	КонецЕсли;
КонецПроцедуры
