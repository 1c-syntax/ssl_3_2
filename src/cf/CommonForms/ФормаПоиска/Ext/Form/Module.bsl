...
Функция НоваяФорматированнаяСтрокаОшибки()
	...
	Рекомендации = 
		НСтр("ru = '<span style=""color: ПолнотекстовыйПоискЦветЗаголовкаРекомендаций; font: ПолнотекстовыйПоискШрифтЗаголовкаРекомендаций"">Рекомендации:</span>
			|
			|%1%2
			|<span style=""font: ПолнотекстовыйПоискШрифтПунктаРекомендаций"">       • Воспользуйтесь поиском по началу слова.</span>
			...
			|
			|<span style=""font: ПолнотекстовыйПоискШрифтПунктаРекомендаций"">       • Воспользуйтесь нечетким поиском.</span>
			|         Используйте решетку (#).
	...
	Если КодОшибки = "НичегоНеНайдено" Тогда 
		...
		Если ИскатьВРазделах И УказаныОбластиПоиска Тогда 
			...
			РекомендацияОбластиПоиска = 
				НСтр("ru = '<span style=""font: ПолнотекстовыйПоискШрифтПунктаРекомендаций"">       • Уточните область поиска.</span>
				|         Попробуйте выбрать больше областей поиска или все разделы.'") + Символы.ПС;
			
		КонецЕсли;
		
		РекомендацияТекстЗапроса =
			НСтр("ru = '<span style=""font: ПолнотекстовыйПоискШрифтПунктаРекомендаций"">       • Упростите запрос, исключив из него какое-либо слово.</span>'") + Символы.ПС;
	...
	Рекомендации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Рекомендации,
		РекомендацияОбластиПоиска, РекомендацияТекстЗапроса,
