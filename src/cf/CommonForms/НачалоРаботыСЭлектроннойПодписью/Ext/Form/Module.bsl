...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НеУстановленоОдновременных = 1 Тогда
		Если Не Параметры.РасширениеРаботыС1СПредприятиемУстановлено
			Или Не Параметры.РасширениеРаботыСКриптографиейУстановлено Тогда
			Элементы.УстановитьВсе.Заголовок = НСтр("ru = 'Установить расширение'");
		Иначе
			Элементы.УстановитьВсе.Заголовок = НСтр("ru = 'Установить компоненту'");
		КонецЕсли;
	ИначеЕсли НеУстановленоОдновременных = 2 Тогда
		Если Не Параметры.РасширениеРаботыС1СПредприятиемУстановлено
			И Не Параметры.РасширениеРаботыСКриптографиейУстановлено Тогда
			Элементы.УстановитьВсе.Заголовок = НСтр("ru = 'Установить расширения'");
		Иначе
			Элементы.УстановитьВсе.Заголовок = НСтр("ru = 'Установить расширение и компоненту'");
		КонецЕсли;
	Иначе
		Элементы.УстановитьВсе.Заголовок = НСтр("ru = 'Установить расширения и компоненту'");
	КонецЕсли;
...
&НаКлиенте
Процедура ДекорацияКриптопровайдерУстановленРасширеннаяПодсказкаОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
...
Процедура УстановитьЗначениеДекорацийВЗависимостиОтСостоянияУстановкиКомпонент()
	...
	Если СостояниеУстановкиКриптопровайдера = 2 Тогда
		...
		Элементы.ДекорацияКриптопровайдерУстановлен.ОтображениеПодсказки = ОтображениеПодсказки.Нет;
	...
	Иначе
		...
		Элементы.ДекорацияКриптопровайдерУстановлен.ОтображениеПодсказки = ОтображениеПодсказки.ОтображатьСнизу;
	КонецЕсли;
