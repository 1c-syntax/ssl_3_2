...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВывестиДополнительнуюИнформацию();
...
&НаСервере
Процедура ВывестиДополнительнуюИнформацию()
	
	ИдентификаторСообщения = "ПредупреждениеОВыбранномСпособеАвторизации";
	ОбщегоНазначенияКлиентСервер.УдалитьСтатусИлиВажноеСообщение(ЭтотОбъект, ИдентификаторСообщения);
	ДополнительнаяИнформация = НастройкиПровайдера.ИнформацияПоСпособамАвторизации;
	
	Если ДополнительнаяИнформация.Свойство(СпособАвторизации) Тогда
		...
		ПараметрыСообщения.Сообщение = ДополнительнаяИнформация[СпособАвторизации];
		ПараметрыСообщения.КраткоеПредставление = ПараметрыСообщения.Сообщение;
