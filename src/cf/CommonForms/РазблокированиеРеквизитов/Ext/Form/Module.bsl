...
Процедура ДобавитьЭлементыНаФорму(ДобавляемыеЭлементы)
	...
	Для Каждого ДобавляемыйЭлемент Из ДобавляемыеЭлементы Цикл
		Если ДобавляемыйЭлемент.ЭтоНадпись Тогда
			ЭлементНадписи = Элементы.Вставить(ДобавляемыйЭлемент.Имя,
				Тип("ДекорацияФормы"), Элементы.Надпись, Элементы.ФормаПроверитьИспользование);
...
Процедура УстановитьВидимостьКомандФормы()
	...
	Элементы.ФормаПроверитьИспользование.Видимость = ПоказатьКоманды;
