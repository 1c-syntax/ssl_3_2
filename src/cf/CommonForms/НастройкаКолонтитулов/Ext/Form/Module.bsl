...
Процедура ОпределитьПоведениеВМобильномКлиенте()
	...
	Элементы.ВыводитьВерхнийКолонтитулСоСтраницы.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Авто;
	Элементы.ВыводитьНижнийКолонтитулСоСтраницы.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Авто;
	Элементы.ПримерСтраницы.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Авто;
	Элементы.ПримерСтраницыНижний.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Авто;
...
Процедура ПодготовитьОбразец()
	...
	Образец.Область(3, 2).ВертикальноеПоложение = ВертикальноеПоложение.Центр;
