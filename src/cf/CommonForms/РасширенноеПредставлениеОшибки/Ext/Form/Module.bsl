...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ПоказатьТребуетсяПомощь Тогда
		...
		Если ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
			Элементы.ФормаПерейтиКНастройкеПрограмм.Важность = 
				?(Не Элементы.ФормаУстановитьРасширение.Видимость И Элементы.ФормаПерейтиКНастройкеПрограмм.Видимость,
				ВажностьКнопки.Главная,
				ВажностьКнопки.Обычная);
		Иначе
			Элементы.ФормаПерейтиКНастройкеПрограмм.КнопкаПоУмолчанию = 
				?(Не Элементы.ФормаУстановитьРасширение.Видимость И Элементы.ФормаПерейтиКНастройкеПрограмм.Видимость,
				Истина,
				Ложь);
		КонецЕсли;
	...
	Если Параметры.ПоказатьТребуетсяПомощь И ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ОбращенияВТехническуюПоддержку") Тогда
