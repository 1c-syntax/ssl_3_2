...
Процедура ОбновитьВидимостьНаСервере()
	...
	Если ТребуетсяУстановкаОбновления Тогда
		...
		Элементы.ФормаУстановитьОбновление.Видимость = РольДоступнаНастройкаСинхронизацииДанных;
		
		Если РольДоступнаНастройкаСинхронизацииДанных Тогда
			Элементы.ФормаУстановитьОбновление.АктивизироватьПоУмолчанию = Истина;
		КонецЕсли;
	...
	ИначеЕсли ТребуетсяПерезагрузка Тогда
		...
		Элементы.ФормаПерезапуститьПрограмму.Видимость = Истина;
		Элементы.ФормаПерезапуститьПрограмму.АктивизироватьПоУмолчанию = Истина;
		
	Иначе
		
		Элементы.АвтономнаяРабота.ТекущаяСтраница = Элементы.СинхронизацияДанных;
		
		Элементы.ФормаВыполнитьСинхронизациюДанных.Видимость = Истина; 
		Элементы.ФормаАрхивСообщенийОбменов.Видимость = Истина;

		Элементы.ФормаВыполнитьСинхронизациюДанных.АктивизироватьПоУмолчанию = Истина;
