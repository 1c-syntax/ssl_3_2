...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтобразитьВидимостьСтраниц(ЭтотОбъект);
...
Процедура ОтобразитьВидимостьСтраниц(Форма)
	
	Элементы = Форма.Элементы;
	ЕстьОшибки = Форма.Ошибки.Количество() > 0;
	
	Если ЕстьОшибки Тогда
		Элементы.Ошибки.Видимость = Истина;
		Элементы.Страницы.ТекущаяСтраница = Элементы.СтраницаНеУдалосьПродлить;
		Элементы.ВыполнитьДействия.Видимость = Ложь;
	Иначе
