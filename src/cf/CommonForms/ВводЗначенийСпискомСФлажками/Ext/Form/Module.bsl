...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(КоманднаяПанель, Элементы.Список.КоманднаяПанель, "ЗавершитьРедактирование");
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппе(Элементы.Список.КоманднаяПанель,
			"СписокДобавлениеУдаление
			|СписокВключениеОтключениеФлажков
			|СписокСортировка
			|СписокПеремещение");
	КонецЕсли;
