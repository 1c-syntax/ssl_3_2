...
Функция ИзвлечьИсправлениеИзАрхива(Знач ПомещенныйФайл, ПроверятьПрименимостьПоМанифесту = Ложь)
	...
	Попытка
		...
		Если ПроверятьПрименимостьПоМанифесту Тогда
			...
			ИсправлениеПрименимо = ИсправлениеПрименимо(ЧтениеАрхива, ВременныйКаталог);
...
Функция ИсправлениеПрименимо(ЧтениеАрхива, ВременныйКаталог)
	ФайлМанифеста = ЧтениеАрхива.Элементы.Найти("Manifest.xml");
	...
	Попытка
		ЧтениеАрхива.Извлечь(ФайлМанифеста, ВременныйКаталог);
