...
Процедура ПриОпределенииСправочниковДляЗагрузкиДанных(ЗагружаемыеСправочники) Экспорт
	...
	// Элементы справочника создаются программно, интерактивное создание не предусмотрено.
	СтрокаТаблицы = ЗагружаемыеСправочники.Найти(Метаданные.Справочники.НаборыДополнительныхРеквизитовИСведений.ПолноеИмя(), "ПолноеИмя");
...
Процедура ПеренестиУстановленныеМеткиВОбъект(Форма, Объект = Неопределено) Экспорт
	...
	Для каждого УстановленнаяМетка Из Форма.Свойства_УстановленныеМетки Цикл
		...
		Метка.Свойство = УстановленнаяМетка.Свойство;
