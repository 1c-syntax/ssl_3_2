...
Функция ДействиеПроверитьУстановкуПриложенийКриптографии() Экспорт
	Возврат "ПроверитьУстановкуПриложенийКриптографии";
КонецФункции
...
Функция СвойстваСертификата(Сертификат, РазницаСУниверсальнымВременем, ДвоичныеДанныеСертификата = Неопределено) Экспорт
	...
	Если ТипЗнч(Сертификат) = Тип("СертификатКриптографии") И ДоступныДополнительныеСвойстваСертификата() Тогда
		...
		ДанныеКлючаУдостоверяющегоЦентра = Сертификат.ДополненияСертификатаКакИсходныеДанные["2.5.29.35"];
