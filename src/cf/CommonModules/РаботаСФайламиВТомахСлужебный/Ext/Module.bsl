...
//
Процедура ДобавитьФайлыВТома(ПолноеИмяФайлаZip) Экспорт
	
	ИмяКаталога = ФайловаяСистема.СоздатьВременныйКаталог();
	СоздатьКаталог(ИмяКаталога);
	
	ZipФайл = Новый ЧтениеФайлаАрхива(ПолноеИмяФайлаZip);
	ZipФайл.ИзвлечьВсе(ИмяКаталога, РежимВосстановленияПутейФайлаАрхива.НеВосстанавливать);
