...
Функция ИзвлечьФайлыПакета(НосительМакетов, ИмяМакета) Экспорт
	...
	ЧтениеФайлаАрхива = Новый ЧтениеФайлаАрхива(АрхивПолноеИмя);
	ЧтениеФайлаАрхива.ИзвлечьВсе(КаталогВременныхФайлов, РежимВосстановленияПутейФайлаАрхива.Восстанавливать);
	ЧтениеФайлаАрхива.Закрыть();
	ЧтениеФайлаАрхива = Неопределено;
