...
Функция ПредставлениеДанныхСтруктуры(ДанныеСобытия, ПредставлениеКлючей, КромеСвойстваДанные = Ложь)
	...
	Дерево = ДеревоИзДанныхСтруктуры(ДанныеСобытия, 0,
...
//  КоличествоСтрок - Число - возвращаемое значение.
...
//   * ЕстьЗначение - Булево
//
Функция ДеревоИзДанныхСтруктуры(ДанныеСобытия, КоличествоСтрок, ПредставлениеКлючей = Неопределено,
	...
	ДобавитьСвойстваВДерево(Дерево.Строки, ДанныеСобытия, ПредставлениеКлючей,
		ТолькоЗаполненные, ИсключаемыеСвойства, КоличествоСтрок);
...
Процедура ДобавитьСвойстваВДерево(СтрокиДерева, ОписаниеСвойств, ПредставлениеКлючей,
			ТолькоЗаполненные, ИсключаемыеСвойства, КоличествоСтрок, Знач КлючРодителя = "")
		...
		Если ТипЗнч(Значение) = Тип("Структура")
		 ...
		 Или ТипЗнч(Значение) = Тип("ФиксированноеСоответствие") Тогда
			...
			ДобавитьСвойстваВДерево(НоваяСтрока.Строки, Значение, ПредставлениеКлючей,
				ТолькоЗаполненные, ИсключаемыеСвойства, КоличествоСтрок, ПолныйКлюч);
