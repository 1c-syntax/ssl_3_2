...
Процедура ОбработатьДействияВИнформационномСообщении(Форма, ИмяКоманды) Экспорт
	КонтрольВеденияУчетаКлиент.ОткрытьОтчетПоПроблемамОбъекта(Форма, Форма.Объект.Ссылка, Ложь);
КонецПроцедуры
