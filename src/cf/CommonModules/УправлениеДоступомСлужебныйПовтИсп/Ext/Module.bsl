...
//
// Параметры:
//  ПроверятьАктуальностьОписанияВидовДоступа - Булево
//
// Возвращаемое значение:
//  ФиксированнаяСтруктура:
...
//        ** Дата - Дата
// 
Функция ОписаниеПоставляемыхПрофилейСеанса(ПроверятьАктуальностьОписанияВидовДоступа = Истина) Экспорт
	
	ОписаниеВидовДоступа = ?(ПроверятьАктуальностьОписанияВидовДоступа, Неопределено,
		УправлениеДоступомСлужебныйПовтИсп.ОписаниеСвойствВидовДоступаСеанса().СвойстваСеанса);
	
	ХешСумма = "";
	ПоставляемыеПрофилиСеанса = Справочники.ПрофилиГруппДоступа.ПроверенныеПоставляемыеПрофилиСеанса(
		ОписаниеВидовДоступа, ХешСумма);
