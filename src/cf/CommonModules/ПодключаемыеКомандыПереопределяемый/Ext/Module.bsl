...
//	Вид.ВажностьПриОтображении = ВажностьПриОтображении.Высокая;
//	
...
//         * ОтображениеКнопки - ОтображениеКнопки - режим отображения кнопки.
//   
...
//       * ИспользованиеТекущейСтроки   - Строка - допустимые значения: Использует, НеИспользует, Авто.
//     
//       3) Настройки процесса выполнения.
//       * МножественныйВыбор - Булево - если Истина, то команда поддерживает множественный выбор.
//             В этом случае в параметре выполнения будет передан список ссылок, и значение свойства ИспользованиеВыделенныхСтрок
//             у команды будет установлено ИспользованиеВыделенныхСтрок.Использует.
//             Если Ложь, то значение свойства ИспользованиеВыделенныхСтрок у команды будет установлено ИспользованиеВыделенныхСтрок.НеИспользует.
