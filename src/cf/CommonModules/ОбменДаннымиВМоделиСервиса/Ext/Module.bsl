...
//     Значение - имя метода для вызова, например РаботаВМоделиСервиса.ОчиститьДанныеОбъектаМетаданных 
...
// Возвращает поддерживаемые планы обмена.
// 
// Возвращаемое значение:
//  ЗначениеXDTO - планы обмена
//
Функция ПолучитьПланыОбменаКонфигурации() Экспорт
...
Процедура ИзменитьПризнакНеобходимостиОбменаДаннымиВМоделиСервиса(НеобходимоВыполнитьОбмен, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Для ПопыткаИзменения = 1 По КоличествоПопыток Цикл
		...
		Исключение
			...
			ОтменитьТранзакцию();
			ВызватьПаузу(ИнтервалОжидания * 1000);
...
Процедура ЗаблокироватьКонечныеТочки() Экспорт
	...
	Попытка
		...
		Запрос.УстановитьПараметр("КонечнаяТочкаМенеджераСервиса", МодульРаботаВМоделиСервиса.КонечнаяТочкаМенеджераСервиса());
