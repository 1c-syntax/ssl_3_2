...
Функция УстановитьОтборПоЗначениюВТекущейКолонке(ТекущиеДанные, ИмяТекущегоЭлемента,
	...
	Если ИмяТекущегоЭлемента = "Дата" Тогда
		ИмяКолонкиПредставления = "ДатаНачала";
		ИмяКолонкиОтбора = "ДатаОкончания";
		
	ИначеЕсли ИмяТекущегоЭлемента = "ПредставлениеМетаданных" Тогда
	...
	Если ТекущиеДанные = Null Тогда
		Результат = Ложь;
		Если ОтборЖурналаРегистрации.Свойство(ИмяКолонкиОтбора) Тогда
			ОтборЖурналаРегистрации.Удалить(ИмяКолонкиОтбора);
			Результат = Истина;
		КонецЕсли;
		Если ОтборЖурналаРегистрации.Свойство(ИмяКолонкиПредставления) Тогда
