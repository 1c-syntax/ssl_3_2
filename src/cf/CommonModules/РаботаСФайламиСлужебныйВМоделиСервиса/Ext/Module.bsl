...
Процедура ВыполнитьДедупликацию() Экспорт
	...
	Для Каждого ОбластьДанных Из ИспользуемыеОбластиДанных Цикл
...
Процедура ОбработатьОчередьИзвлеченияТекста() Экспорт
	...
	|	И ОчередьИзвлеченияТекста.ОбластьДанныхВспомогательныеДанные В (&ИспользуемыеОбластиДанных)";
	...
	Запрос.УстановитьПараметр("ИспользуемыеОбластиДанных", МодульРаботаВМоделиСервиса.ИспользуемыеОбластиДанных());
