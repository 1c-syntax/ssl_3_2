...
//                                         режиме работы или идентификатор ссылки задания очереди в модели сервиса.
//                                       - СправочникСсылка - идентификатор задания
...
//             * Шаблон                  - СправочникСсылка - шаблон задания, используется только
...
//        * УникальныйИдентификатор      - СправочникСсылка - идентификатор задания
//                                            очереди в модели сервиса.
...
//                - СправочникСсылка - идентификатор задания очереди в модели сервиса.
//                - СтрокаТаблицыЗначений из см. НайтиЗадания
// 
// Возвращаемое значение:
