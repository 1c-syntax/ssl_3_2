...
//
// Ограничения
// - Не работает с точками маршрутов бизнес-процессов.
// - Вызывает исключение при неверном формате имени или отсутствии объекта в конфигурации.
// 
// Параметры:
...
// Возвращаемое значение:
//   Структура:
//      * Наименование  - Строка - представление статуса. Рекомендуемая длина до 15 символов. Заполнять обязательно.
