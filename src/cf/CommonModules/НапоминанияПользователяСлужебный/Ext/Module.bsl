...
Процедура ПриСозданииНаСервере(Форма, ПараметрыРазмещения) Экспорт
	...
	Если Форма.Элементы.Найти(ИмяГруппыЭлементов) = Неопределено Тогда
		...
		ПолеВвода.ПоложениеЗаголовка = НастройкиНапоминания.ПоложениеЗаголовкаПоляВвода;
		...
		НастройкиНапоминания.Удалить("ПоложениеЗаголовкаПоляВвода");
...
Функция ПараметрыРазмещения() Экспорт
	...
	Результат.Вставить("ПоложениеЗаголовкаПоляВвода", ПоложениеЗаголовкаЭлементаФормы.Авто);
