...
Процедура ПоказатьНастройкиЦентраМониторинга(ФормаВладелец, ПараметрыФормы) Экспорт
	ОткрытьФорму("Обработка.НастройкиЦентраМониторинга.Форма.НастройкиЦентраМониторинга",
		ПараметрыФормы, ФормаВладелец,,,,, РежимБлокировкиПриОткрытииОкнаФормы.БлокироватьВладельца);
КонецПроцедуры
...
Процедура ПоказатьНастройкуОтправкиКонтактнойИнформации(ФормаВладелец) Экспорт
	ОткрытьФорму("Обработка.НастройкиЦентраМониторинга.Форма.ОтправкаКонтактнойИнформации",,
		ФормаВладелец,,,,, РежимБлокировкиПриОткрытииОкнаФормы.БлокироватьВладельца);
КонецПроцедуры
