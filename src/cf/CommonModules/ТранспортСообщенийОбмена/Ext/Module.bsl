...
Процедура ОформитьПолеПароля(Форма, Реквизит, Элемент) Экспорт
	
	Если ЗначениеЗаполнено(Реквизит) Тогда
		УстановитьПривилегированныйРежим(Истина);
		ПарольУстановлен = ЗначениеЗаполнено(ОбщегоНазначения.ПрочитатьДанныеИзБезопасногоХранилища(Реквизит));
		УстановитьПривилегированныйРежим(Ложь);
...
Функция ЗапаковатьСообщениеОбменаВZipФайл(Транспорт, Пароль) Экспорт
	...
	Попытка
		...
		Архиватор = Новый ЗаписьФайлаАрхива(ИмяВременногоФайлаАрхива, Пароль, ТипФайлаАрхива.ZIP, НСтр("ru = 'Файл сообщения обмена'"));
...
Функция РаспаковатьСообщениеОбменаИзZipФайла(Транспорт, ИмяФайлаАрхива, Пароль) Экспорт
	...
	Архив = Новый ЧтениеФайлаАрхива(ИмяФайлаАрхива, Пароль);
	ФайлВАрхиве = Архив[0];
