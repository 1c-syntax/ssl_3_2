...
Процедура ОбработатьАдресныйКлассификатор(Знач Дескриптор, Знач ПутьКФайлу)
	...
	Попытка
		ЧтениеZIP = Новый ЧтениеФайлаАрхива(ПутьКФайлу);
		ЧтениеZIP.ИзвлечьВсе(КаталогФайлов, РежимВосстановленияПутейФайлаАрхива.НеВосстанавливать);
		ЧтениеZIP.Закрыть();
...
Функция ФайлЗагрузкиСубъектаРФ(КодСубъектаРФ, КаталогФайлов, КлючВида, ИмяОписывающегоУзла)
	...
	Если Файл.Существует Тогда
		...
		ЧтениеZipФайла = Новый ЧтениеФайлаАрхива(Файл.ПолноеИмя);
