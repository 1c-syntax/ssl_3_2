...
Процедура ОповеститьОИзмененииНастроек(Форма) Экспорт 
	...
	ТекстСостояния = НСтр("ru = 'Изменились настройки.'");
...
//  ВариантОтображения - ВариантОтображенияСостояния
//
Процедура ОтобразитьСостояниеОтчета(Форма, Знач ТекстСостояния = "", Знач КартинкаСостояния = Неопределено, 
	Знач ВариантОтображения = Неопределено) Экспорт 
	...
	ВариантОтображения = ?(ВариантОтображения = Неопределено, ВариантОтображенияСостояния.ТекущееСостояние, ВариантОтображения);
	...
	ОтображениеСостояния.ВариантОтображения = ВариантОтображения;
	ОтображениеСостояния.ИмяКоманды = ?(Форма.Команды.Найти("ОтчетСкомпоноватьРезультат") <> Неопределено,
		"ОтчетСкомпоноватьРезультат", "");
