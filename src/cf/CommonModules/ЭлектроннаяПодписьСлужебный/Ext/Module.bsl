...
//  ИмяОформляемогоПоля - Строка
//
Процедура ОформитьСписокПодписей(Форма, ИмяСпискаПодписей, ИмяОформляемогоПоля) Экспорт
...
Процедура НастроитьФормуОбщихНастроек(Форма, РеквизитПутьКДанным) Экспорт
	...
	Если РеквизитПутьКДанным = "РазрешитьДоступКИнтернетСервисамЭлектроннойПодписи" Или  РеквизитПутьКДанным = ""
	 Или РеквизитПутьКДанным = "РазрешитьДоступКИнтернетСервисам" Тогда
		...
		Элементы.ДекорацияРазрешитьЗагрузкуИзИнтернетаВЭлектроннойПодписи.Видимость = Не РазрешенДоступКИнтернетСервисам;
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	Для Каждого ТипОрганизация Из ТипыОрганизаций Цикл
		
		МетаданныеОрганизация = Метаданные.НайтиПоТипу(ТипОрганизация);
		Если МетаданныеОрганизация = Неопределено Тогда
			Продолжить;
		КонецЕсли;
		
		ИмяМетаданногоОрганизация = МетаданныеОрганизация.Имя;
		
		Описание = Описание + "
			|Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования.Чтение." + ИмяМетаданногоОрганизация + "
			|Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования.Изменение." + ИмяМетаданногоОрганизация + "
			|";
