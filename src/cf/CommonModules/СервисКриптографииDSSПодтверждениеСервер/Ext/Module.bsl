...
Процедура ПодготовитьГруппуПодтвержденияЭлементы(КонтекстФормы, ТекущиеЭлементыФормы)
	...
	ГруппаПодтвержденияОписание.ОтображатьКакКарточку = Истина;
	ГруппаПодтвержденияОписание.ЦветФона = ЦветаПалитры.ПервыйБрендовый;
	...
	ГруппаПодтвержденияКод.РастягиватьПоВертикали = Истина;
	ГруппаПодтвержденияКод.РастягиватьПоГоризонтали = Истина;
	...
	ГруппаПодтвержденияУчетнаяЗапись.РастягиватьПоГоризонтали = Ложь;
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, ИменаЭлементов, "ПодтверждениеЛогин", НСтр("ru = 'Учетная запись'", КодЯзыка), ГруппаПодтвержденияУчетнаяЗапись, , "ПолеВвода");
	...
	ЭлементФормы.ИспользоватьКопирование = Истина;
	ЭлементФормы.АвтоМаксимальнаяШирина = Ложь;
	...
	ГруппаИнструкции.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Лево;
	...
	ЭлементФормы.ПропускатьПриВводе = Ложь;
	ЭлементФормы.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Лево;
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, ИменаЭлементов, "ПодтверждениеОК", "Подтвердить", ЭлементыФормы.ФормаКоманднаяПанель, "КнопкаФормы");
	УстановитьПутьКДанным(ЭлементФормы, РеестрИмен, ТекущаяКоманда.Имя, "ИмяКоманды");
	ЭлементФормы.ПропускатьПриВводе = Ложь;
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		ТекущаяКоманда.НазначениеДействия = НазначениеДействияКомандыФормы.Завершение;
	КонецЕсли;
	...
	ЭлементФормы.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Лево;
	Если ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		ТекущаяКоманда.НазначениеДействия = НазначениеДействияКомандыФормы.Обычное;
	КонецЕсли;
...
Функция ДобавитьЭлемент(ЭлементыФормы, ИменаЭлементов, ИмяЭлемента, ЗаголовокЭлемента, ЭлементВладелец, ТипЭлемента = "ПолеФормы", ВидПоля = "")
	...
	Если СтрНайти(ИмяЭлемента, "Линия") = 0 Тогда
		Результат.Видимость = Ложь; // Видимость элементов устанавливается в СервисКриптографииDSSПодтверждениеКлиент.
	КонецЕсли;
