...
Функция НаименованиеРегионаБезТипа(Наименование)
	...
	Если СтрНачинаетсяС(ВРег(Наименование), ВРег("Ханты-Мансийский Автономный округ - Югра"))
		Или СтрНачинаетсяС(ВРег(Наименование), ВРег("Кемеровская область - Кузбасс")) Тогда // @Non-NLS-1,  @Non-NLS-2
			Возврат Истина; 
	КонецЕсли;
