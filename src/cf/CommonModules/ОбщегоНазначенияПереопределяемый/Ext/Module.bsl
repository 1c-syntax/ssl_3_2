...
//      * ГруппироватьСтатусыИВажныеСообщенияГоризонтально - Булево - по умолчанию Ложь. Настройка применяется только для
//              интерфейса такси, если Истина - важные сообщения и статусы будут отображаться горизонтально.
//
...
// Дополнительный обработчик одноименного события, возникающего
...
//                - ПерерасчетНаборЗаписей - смотри описание одноименного обработчика в синтакс-помощнике.
//  ОтправкаЭлемента - ОтправкаЭлементаДанных - смотри описание одноименного обработчика в синтакс-помощнике.
//  СозданиеНачальногоОбраза - Булево - смотри описание одноименного обработчика в синтакс-помощнике.
//
...
// Параметры:
//  Источник          - ПланОбменаОбъект - узел, для которого выполняется обмен.
//  ЭлементДанных     - см. ПриОтправкеДанныхПодчиненному.ЭлементДанных
//  ОтправкаЭлемента  - ОтправкаЭлементаДанных - смотри описание одноименного обработчика в синтакс-помощнике.
//
...
//  Источник          - ПланОбменаОбъект - узел, для которого выполняется обмен.
//  ЭлементДанных     - см. ПриОтправкеДанныхПодчиненному.ЭлементДанных
//  ПолучениеЭлемента - ПолучениеЭлементаДанных - смотри описание одноименного обработчика в синтакс-помощнике.
//  ОтправкаНазад     - Булево - смотри описание одноименного обработчика в синтакс-помощнике.
//
...
//
// Параметры:
//  ЭтоБазовая - Булево - признак того, что версия программы является базовой.
//                        По умолчанию Истина, если в имени программы есть слово "Базовая".
//
