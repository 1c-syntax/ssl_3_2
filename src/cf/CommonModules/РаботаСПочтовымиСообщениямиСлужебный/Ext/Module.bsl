...
//    * КонтекстДляПояснения      - Строка - см. КонтекстДляПояснения.
//    * ИменаСерверовДляПояснения - Строка - см. ИменаСерверовДляПояснения.
//
...
Функция ЭтоАвтоматическаяНастройка(ПараметрыПояснения)
	...
	Возврат ПараметрыПояснения.КонтекстДляПояснения = КонтекстДляПояснения().АвтоматическаяНастройка;
