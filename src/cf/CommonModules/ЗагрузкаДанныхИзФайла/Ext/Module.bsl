...
Функция ОписаниеЗагружаемыхДанныхДляСправочников(ЗагружаемыеДанные, ОписаниеТипаОбъектаСопоставления, ЗаголовокКолонкиОбъектаСопоставления) Экспорт
	...
	ЗагружаемыеДанные.Колонки.Добавить(ЗагрузкаДанныхИзФайлаКлиентСервер.ИмяКолонкиОбъектСопоставления(), 
		ОписаниеТипаОбъектаСопоставления, ЗаголовокКолонкиОбъектаСопоставления);
