...
Функция КонтекстноеМенюОбластиЗаголовка()
	...
	// Сортировать
	КонтекстноеМеню.Добавить(НаправлениеСортировкиКомпоновкиДанных.Возр, НСтр("ru = 'Сортировать по возрастанию'"),, БиблиотекаКартинок.ОтсортированоПоВозрастанию);
	КонтекстноеМеню.Добавить(НаправлениеСортировкиКомпоновкиДанных.Убыв, НСтр("ru = 'Сортировать по убыванию'"),, БиблиотекаКартинок.ОтсортированоПоУбыванию);
...
Функция СвойстваЗаголовкаОтчета(Форма)
	...
	Если СтрЗаканчиваетсяНа(Форма.ИмяФормы, "Форма")
		...
		Возврат Заголовки.Получить(Область.Имя);
