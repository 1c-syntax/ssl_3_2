...
// Открывает форму списка сценариев синхронизации (без отбора).
//
// Параметры:
//  Владелец - форма - владелец для открываемой формы;
//
Процедура ОбработкаКомандыСценарииСинхронизаций(Владелец) Экспорт
	
	ПараметрыФормы = Новый Структура;
	ОткрытьФорму("Справочник.СценарииОбменовДанными.Форма.ФормаСписка", ПараметрыФормы, Владелец);
