...
//    * ШиринаПоляКомментарий - Число - Устарело. Значение игнорируется.
//    * ОтображатьИконки - Булево - Устарело. Значение игнорируется.
//    * ПоложениеКнопкиДобавить - ГоризонтальноеПоложениеЭлемента - Устарело. Значение игнорируется.
//
//  Пример:
