...
Процедура УстановитьПрефиксОбластиДанных(Знач Префикс)
	...
	Если ПустаяСтрока(МодульРаботаВМоделиСервиса.ПолучитьПрефиксОбластиДанных()) Тогда
		
		МодульРаботаВМоделиСервиса.УстановитьПрефиксОбластиДанных(Формат(Префикс, "ЧЦ=2; ЧВН=; ЧГ=0"));
