...
//                                Если значение не указано, то будет установлена важность "Обычное".
...
//   * ИспользованиеТекущейСтроки - Строка - допустимые значения: Использует, НеИспользует, Авто. Если значение не
//                                           указано - Авто.
