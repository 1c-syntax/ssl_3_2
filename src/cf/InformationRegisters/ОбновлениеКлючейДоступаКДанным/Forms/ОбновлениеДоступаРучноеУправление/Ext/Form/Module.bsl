...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбновлениеДоступаЭлементовСписка = Истина;
...
Процедура ПриОткрытии(Отказ)
	...
	ОбновлениеДоступаЭлементовСпискаПриИзменении(Элементы.ОбновлениеДоступаЭлементовСписка);
...
&НаКлиенте
Процедура ОбновлениеДоступаЭлементовСпискаПриИзменении(Элемент)
	
	Элементы.Страницы.ТекущаяСтраница = ?(ОбновлениеДоступаЭлементовСписка,
		Элементы.СтраницаПланированиеОбновлениеДоступа,
		Элементы.СтраницаОбновлениеДоступаКОбъекту);
	
	Элементы.ЗапланироватьОбновлениеДоступаСписков.Видимость = ОбновлениеДоступаЭлементовСписка;
	Элементы.ОбновитьДоступКОбъекту.Видимость = Не ОбновлениеДоступаЭлементовСписка;
