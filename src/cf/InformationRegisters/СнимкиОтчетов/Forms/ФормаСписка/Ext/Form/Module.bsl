...
#Если НЕ МобильныйАвтономныйСервер Тогда
	Если Пользователи.ЭтоПолноправныйПользователь() Тогда
		Элементы.ФормаВсеСнимкиОтчетов.Видимость = Истина;
	КонецЕсли;
#КонецЕсли
...
#Если МобильныйКлиент Тогда
	Если ОсновнойСерверДоступен() = Ложь Тогда
		Элементы.ФормаОбновитьСнимкиОтчетов.Доступность = Ложь;
	КонецЕсли;
#КонецЕсли
...
Процедура ОбновитьСнимкиОтчетов(Команда)
	...
	ИдентификаторыСтрок = Элементы.СнимкиОтчетов.ПолучитьСтрокиДляОбработки();
...
&НаКлиенте
Процедура ВсеСнимкиОтчетов(Команда)
	
	НовоеЗначение = Не Элементы.ФормаВсеСнимкиОтчетов.Пометка;
	ПоказатьВсеСнимкиОтчетов = НовоеЗначение;
	Элементы.ФормаВсеСнимкиОтчетов.Пометка = НовоеЗначение;
