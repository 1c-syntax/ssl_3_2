...
Процедура УстановитьВидимость()
	...
	Если ВыбранныйСпособ <> Неопределено Тогда
		Если ВыбранныйСпособ = ПредопределенноеЗначение("Перечисление.СпособыУстановкиВремениНапоминания.ВУказанноеВремя") Тогда
			...
			Элементы.Время.Доступность = Истина;
...
Процедура ОбновитьРасчетноеВремяНапоминания()
	...
	Если ВыбранныйСпособ <> ПредопределенноеЗначение("Перечисление.СпособыУстановкиВремениНапоминания.ВУказанноеВремя")
		И Элементы.ПанельДетальныхНастроек.ТекущаяСтраница = Элементы.ДатаВремя Тогда
		ТекущаяДата = ОбщегоНазначенияКлиент.ДатаСеанса();
		Объект.ВремяСобытия = ТекущаяДата + Объект.ИнтервалВремениНапоминания;
	КонецЕсли
