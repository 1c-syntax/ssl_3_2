...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(Элементы.СписокОбработчиков.КоманднаяПанель, КоманднаяПанель);
	КонецЕсли;
КонецПроцедуры
...
Процедура ВыбратьВсе(Команда)
	...
	ПараметрыПоиска.Вставить("Выбран", Ложь);
