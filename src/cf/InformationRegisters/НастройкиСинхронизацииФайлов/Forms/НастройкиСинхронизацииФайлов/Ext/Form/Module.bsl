...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.АвтоматическиСинхронизироватьФайлы.РасширеннаяПодсказка.Заголовок = Новый ФорматированнаяСтрока(Строка(ТекущееРасписание()), , , , "Ссылка");
	Если Не АвтоматическиСинхронизироватьФайлы Тогда
		Элементы.АвтоматическиСинхронизироватьФайлы.ОтображениеПодсказки = ОтображениеПодсказки.Нет;
	КонецЕсли;
	
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		Элементы.АвтоматическиСинхронизироватьФайлы.РасширеннаяПодсказка.Видимость = Ложь;
	КонецЕсли;
...
Процедура АвтоматическиСинхронизироватьФайлыПриИзменении(Элемент)
	...
	Если Не АвтоматическиСинхронизироватьФайлы Тогда
		Элементы.АвтоматическиСинхронизироватьФайлы.ОтображениеПодсказки = ОтображениеПодсказки.Нет;
	Иначе
		Элементы.АвтоматическиСинхронизироватьФайлы.ОтображениеПодсказки = ОтображениеПодсказки.ОтображатьСнизу;
	КонецЕсли;
...
Процедура ДеревоОбъектовМетаданныхСинхронизироватьПриИзменении(Элемент)
	...
	Если ТекущиеДанные.ПолучитьЭлементы().Количество() > 1 Тогда
		УстановитьЗначениеСинхронизацииПодчиненнымОбъектам(ТекущиеДанные.Синхронизировать, Элементы.ДеревоОбъектовМетаданных.ПолучитьСтрокиДляОбработки());
	Иначе
...
&НаКлиенте
Процедура АвтоматическиСинхронизироватьФайлыРасширеннаяПодсказкаОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
...
Процедура НастроитьРасписаниеЗавершение(Расписание, ДополнительныеПараметры) Экспорт
	...
	Элементы.АвтоматическиСинхронизироватьФайлы.РасширеннаяПодсказка.Заголовок = Новый ФорматированнаяСтрока(Строка(Расписание), , , , "Ссылка");
...
&НаСервере
Процедура УстановитьЗначениеСинхронизацииПодчиненнымОбъектам(Знач Синхронизировать, СтрокиДляОбработки)
...
Процедура УдалитьНастройкуЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда
		...
		УстановитьЗначениеСинхронизацииПодчиненнымОбъектам(Ложь, Элементы.ДеревоОбъектовМетаданных.ПолучитьСтрокиДляОбработки());
		ЗаписатьТекущиеНастройки();
...
Процедура УстановитьВидимостьКомандыСинхронизировать()
	...
	Элементы.ДеревоОбъектовМетаданных.Доступность = ПустаяСтрока(ТекущееФоновоеЗадание);
	Элементы.СтатусФоновогоЗадания.Видимость      = Не ПустаяСтрока(ТекущееФоновоеЗадание);
