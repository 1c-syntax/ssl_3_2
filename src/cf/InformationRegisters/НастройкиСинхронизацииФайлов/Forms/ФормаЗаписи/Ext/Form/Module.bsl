...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВладелецФайлаНеИдентификаторОбъектовМетаданных Тогда
		...
		ПредставлениеВладельцаДляЗаголовка = ТипЗнч(Запись.ВладелецФайла);
	...
	Если Параметры.ЗапрещатьИзменятьУчетнуюЗапись Тогда
		Элементы.УчетнаяЗапись.Вид = ВидПоляФормы.ПолеНадписи;
		Элементы.УчетнаяЗапись.Гиперссылка = Истина;
	КонецЕсли;
...
Процедура ЭлементСправочникаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму(ПутьФормыВыбора(ЭлементСправочника, ИдентификаторВладельцаФайлов), ПараметрыФормыВыбора,
		Элементы.ЭлементСправочника,,,,, РежимБлокировкиПриОткрытииОкнаФормы.БлокироватьВладельца);
