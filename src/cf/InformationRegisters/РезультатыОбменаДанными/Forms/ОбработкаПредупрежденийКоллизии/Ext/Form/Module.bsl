...
#Область ОбработчикиСобытийЭлементовТаблицыФормыТаблицаОбъектовИсправления

&НаКлиенте
Процедура ТаблицаОбъектовИсправленияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	Если Поле.Имя = Элементы.ТаблицаОбъектовИсправленияОписаниеОшибки.Имя Тогда
		ТекущаяСтрока = ТаблицаОбъектовИсправления.НайтиПоИдентификатору(ВыбраннаяСтрока);
		
		ПоказатьЗначение(, ТекущаяСтрока.ОписаниеОшибки);
	КонецЕсли;
...
Процедура УсловноеОформлениеФормы()
	...
	ОшибкиКрасным.Оформление.УстановитьЗначениеПараметра("ТипОтметки", ТипОтметкиЯчейкиТаблицы.ЗначокКруг);
	ОшибкиКрасным.Оформление.УстановитьЗначениеПараметра("ЦветОтметки", WebЦвета.ТемноКрасный);
