...
Процедура ИсточникПравилПриИзменении(Элемент)
	...
	Элементы.ИмяФайлаПравил.Доступность = ИсточникПравил = ПредопределенноеЗначение("Перечисление.ИсточникиПравилДляОбменаДанными.Файл");
...
Процедура НастройкаЭлементовФормы()
	...
	Элементы.ГруппаПланаОбмена.Видимость = ПустаяСтрока(Запись.ИмяПланаОбмена);
	Элементы.ИмяФайлаПравил.Доступность = ИсточникПравил = Перечисления.ИсточникиПравилДляОбменаДанными.Файл;
	Элементы.ФормаСохранитьПравилаРегистрацииВФайл.Видимость = Запись.ПравилаЗагружены;
