...
Процедура УстановитьВидимостьКнопокПослеСменыСтраницы(Форма)
	...
	ТекущаяСтраница = Форма.Элементы.ШагиОчистки.ТекущаяСтраница;
	
	Форма.Элементы.Очистить.Видимость = Ложь;
	Форма.Элементы.ПрерватьОчистку.Видимость = Ложь;
	
	Если ТекущаяСтраница = Форма.Элементы.ВыборРегионовОчистки Тогда
		Форма.Элементы.Очистить.Видимость = Истина;
	ИначеЕсли ТекущаяСтраница = Форма.Элементы.ОжиданиеОчистки Тогда
		Форма.Элементы.ПрерватьОчистку.Видимость = Истина;
	КонецЕсли;
