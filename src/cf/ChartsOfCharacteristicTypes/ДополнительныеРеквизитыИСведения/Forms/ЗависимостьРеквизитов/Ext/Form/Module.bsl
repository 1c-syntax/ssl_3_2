...
Процедура УстановитьЗаголовокФормы()
	...
	НовыйЗаголовок = НСтр("ru = '%1 дополнительного реквизита ""%2""'");
	...
	КонецЕсли;
	НовыйЗаголовок = СтрЗаменить(НовыйЗаголовок, "%1", ПредставлениеСвойства);
	НовыйЗаголовок = СтрЗаменить(НовыйЗаголовок, "%2", СвойстваОбъекта.Заголовок);
	
	Если Не ЗначениеЗаполнено(СвойстваОбъекта.Заголовок)  Тогда
		НовыйЗаголовок = СтрЗаменить(НовыйЗаголовок, """", "");
	КонецЕсли;
