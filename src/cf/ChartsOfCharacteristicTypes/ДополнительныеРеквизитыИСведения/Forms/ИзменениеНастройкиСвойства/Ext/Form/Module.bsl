...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОтдельныеЗначенияРеквизита.РасширеннаяПодсказка.Заголовок =
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Элементы.ОтдельныеЗначенияРеквизита.РасширеннаяПодсказка.Заголовок, ТекущийНаборСвойств);
	
	Элементы.ОбщиеЗначенияРеквизитов.РасширеннаяПодсказка.Заголовок =
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Элементы.ОбщиеЗначенияРеквизитов.РасширеннаяПодсказка.Заголовок, ТекущийНаборСвойств);
	
	Элементы.ОтдельныеЗначенияСведения.РасширеннаяПодсказка.Заголовок =
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Элементы.ОтдельныеЗначенияСведения.РасширеннаяПодсказка.Заголовок, ТекущийНаборСвойств);
	
	Элементы.ОбщиеЗначенияСведений.РасширеннаяПодсказка.Заголовок =
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Элементы.ОбщиеЗначенияСведений.РасширеннаяПодсказка.Заголовок, ТекущийНаборСвойств);
