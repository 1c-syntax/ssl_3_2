...
Функция ПолучитьПланыОбменаКонфигурации()
	...
	Возврат ОбменДаннымиВМоделиСервиса.ПолучитьПланыОбменаКонфигурации();
...
Функция ВыполнитьДействиеСценарияОбменаДаннымиВПервойИнформационнойБазе(ИндексСтрокиСценария, СценарийОбменаДаннымиXDTO)
	...
	Если РежимОбмена = "Ручной" Тогда
		...
		УстановитьПривилегированныйРежим(Истина);
		ОбменДаннымиОперацииВебСервисов.ВойтиВОбластьДанных(СтрокаСценария.ЗначениеРазделителяПервойИнформационнойБазы);
		...
		УстановитьПривилегированныйРежим(Истина);
		ОбменДаннымиОперацииВебСервисов.ВыйтиИзОбластиДанных(СтрокаСценария.ЗначениеРазделителяПервойИнформационнойБазы);
		УстановитьПривилегированныйРежим(Ложь);
...
Функция ВыполнитьДействиеСценарияОбменаДаннымиВоВторойИнформационнойБазе(ИндексСтрокиСценария, СценарийОбменаДаннымиXDTO)
	...
	Если РежимОбмена = "Ручной" Тогда
		...
		УстановитьПривилегированныйРежим(Истина);
		ОбменДаннымиОперацииВебСервисов.ВойтиВОбластьДанных(СтрокаСценария.ЗначениеРазделителяВторойИнформационнойБазы);
		УстановитьПривилегированныйРежим(Ложь);
		...
		УстановитьПривилегированныйРежим(Истина);
		ОбменДаннымиОперацииВебСервисов.ВыйтиИзОбластиДанных(СтрокаСценария.ЗначениеРазделителяВторойИнформационнойБазы);
		УстановитьПривилегированныйРежим(Ложь);
