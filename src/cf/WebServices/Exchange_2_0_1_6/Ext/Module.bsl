...
Функция GetFileFromStorage(FileId)
	...
	Если СтрЗаканчиваетсяНа(ИмяИсходногоФайла, ".zip") Тогда
		ЧтениеАрхива = Новый ЧтениеФайлаАрхива(ИмяИсходногоФайла);
		ЧтениеАрхива.Извлечь(ЧтениеАрхива.Элементы[0], ОбменДаннымиСервер.КаталогВременногоХранилищаФайлов());
		
		ИмяКонечногоФайла = ЧтениеАрхива.Элементы[0].ПолноеИмя;
