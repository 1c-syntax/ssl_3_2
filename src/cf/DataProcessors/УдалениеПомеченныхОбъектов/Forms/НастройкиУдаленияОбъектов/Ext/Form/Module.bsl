...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(КоманднаяПанель, Элементы.НастройкиОтображенияОбъектов.КоманднаяПанель);
		
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппе(Элементы.НастройкиОтображенияОбъектов.КоманднаяПанель,
			"ФормаВыбрать");
	КонецЕсли;
...
Функция НастройкиИзДанныхФормы()
	...
	Если СпособУдаления = 1 Тогда
		Настройки.РежимУдаления = "Упрощенный";
	ИначеЕсли СпособУдаления = 2 Тогда
