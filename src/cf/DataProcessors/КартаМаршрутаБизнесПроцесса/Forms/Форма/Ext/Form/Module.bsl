...
Процедура ОбновитьКартуМаршрута()
	...
	Иначе
		...
		Статус = ?(СвойстваБизнесПроцесса.Стартован, НСтр("ru = 'Стартован'"), НСтр("ru = 'Не стартован'"));
	КонецЕсли;
...
#КонецЕсли
	...
	ПараметрыФормы.Вставить("БлокировкаОкнаВладельца", РежимБлокировкиПриОткрытииОкнаФормы.БлокироватьВладельца);
