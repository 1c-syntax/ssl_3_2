...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ВыборВариантаАвтоматическогоРезервногоКопирования.Видимость = Не ЭтоБазоваяВерсияКонфигурации;
...
Процедура ОбновитьТипОграниченияКаталогаСРезервнымиКопиями(Форма)
	...
	Форма.Элементы.СтраницыОграничения.Доступность = Истина;
	Если Форма.Объект.ТипОграничения = "Все" Тогда
		Форма.Элементы.СтраницыОграничения.Доступность = Ложь;
	ИначеЕсли Форма.Объект.ТипОграничения = "ПоПериоду" Тогда
		Форма.Элементы.СтраницыОграничения.ТекущаяСтраница = Форма.Элементы.ГруппаПериод;
	Иначе
		Форма.Элементы.СтраницыОграничения.ТекущаяСтраница = Форма.Элементы.ГруппаКоличество;
	КонецЕсли;
