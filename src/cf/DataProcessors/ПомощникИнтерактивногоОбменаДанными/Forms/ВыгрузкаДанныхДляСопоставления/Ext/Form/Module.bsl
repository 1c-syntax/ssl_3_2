...
&НаСервере
Функция ДобавитьСтрокуТаблицыПереходов(ИмяОсновнойСтраницы, КомандыНавигации, ИмяСтраницыДекорации = "")
	...
	СтрокаПереходов.КомандыНавигации = КомандыНавигации;
...
Процедура ЗаполнитьТаблицуПереходов()
	...
	ИмяФормаКомандаНазад  = Элементы.ФормаКомандаНазад.Имя;
	ИмяФормаКомандаДалее  = Элементы.ФормаКомандаДалее.Имя;
	ИмяФормаКомандаОтмена = Элементы.ФормаКомандаОтмена.Имя;
	ИмяФормаКомандаГотово = Элементы.ФормаКомандаГотово.Имя;
	
	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаНачало", ИмяФормаКомандаДалее);
	НовыйПереход.ИмяОбработчикаПриОткрытии = "Подключаемый_СтраницаНачало_ПриОткрытии";
	
	Если ДоступнаНастройкаТранспорта Тогда
		КомандыНавигации = ИмяФормаКомандаНазад + "," + ИмяФормаКомандаДалее;
		
		НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаНастройкиПодключения", КомандыНавигации);
	...
	Если ЗапроситьПароль Тогда 
		...
		НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаЗапросПароля", КомандыНавигации);
	...
	Если НЕ ПассивныйРежим Тогда
		НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаПроверкаПодключения", ИмяФормаКомандаОтмена);
	...
	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаРегистрацияИзменений", ИмяФормаКомандаОтмена);
	...
	Если НЕ ПассивныйРежим Тогда
		Если ИспользоватьПрогресс Тогда
			НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаВыгрузкаДанныхПрогресс", ИмяФормаКомандаОтмена);
		Иначе
			НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаВыгрузкаДанныхБезПрогресса", ИмяФормаКомандаОтмена);
		КонецЕсли;
	...
	НовыйПереход = ДобавитьСтрокуТаблицыПереходов("СтраницаОкончание", ИмяФормаКомандаГотово);
...
Процедура ПорядковыйНомерПереходаПриИзменении(Знач ЭтоПереходДалее)
	...
	ДоступностьКомандНавигации = Не (ЭтоПереходДалее И СтрокаПереходаТекущая.ДлительнаяОперация);
	
	КомандыНавигации = СтрРазделить(СтрокаПереходаТекущая.КомандыНавигации, ",");
