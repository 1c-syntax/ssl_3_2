...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ПовторноеСканирование Тогда
		Элементы.Применить.Заголовок = НСтр("ru='Сканировать'");
	КонецЕсли;
...
Процедура ПриОткрытии(Отказ)
	...
	Если Не ОткрытаФормаСканирования() Тогда
...
Процедура УстановитьПодсказки()
	...
	Элементы.ФорматСканированногоИзображения.РасширеннаяПодсказка.Заголовок = ПодсказкаФормата;
