...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТранспортСообщенийОбмена.ОформитьПолеПароля(ЭтотОбъект, Объект.ПарольПользователя, Элементы.Пароль);
...
Процедура ПарольНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	...
	ТранспортСообщенийОбменаКлиент.ПолеПароляНачалоВыбора(Элемент, Объект.ПарольПользователя, СтандартнаяОбработка);
