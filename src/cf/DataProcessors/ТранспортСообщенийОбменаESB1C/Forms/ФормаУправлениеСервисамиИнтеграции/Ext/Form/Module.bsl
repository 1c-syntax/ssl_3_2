...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если КлиентскоеПриложение.ТекущийВариантИнтерфейса() = ВариантИнтерфейсаКлиентскогоПриложения.Версия8_5 Тогда
		Элементы.СервисыИнтеграцииАктивен.КартинкаШапки = Новый Картинка;
		Элементы.СервисыИнтеграцииАдресВнешнегоСервисаИнтеграции.КартинкаШапки = Новый Картинка;
		Элементы.СервисыИнтеграцииИмяИАдрес.Группировка = ГруппировкаКолонок.Горизонтальная;
		Элементы.ФормаВключитьАктивность.Отображение    = ОтображениеКнопки.КартинкаИТекст;
		Элементы.ФормаСнятьАктивность.Отображение 		= ОтображениеКнопки.КартинкаИТекст;
	КонецЕсли;
...
Процедура ОткрытьНастройкиСервисаИнтеграции()
	...
	ОткрытьФорму("Обработка.ТранспортСообщенийОбменаESB1C.Форма.ФормаНастроекСервисовИнтеграции", 
		ПараметрыФормы,
		ЭтотОбъект,,,,
		ОписаниеОповещения);
