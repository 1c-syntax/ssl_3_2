...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыСообщения.Сообщение = СтроковыеФункции.ФорматированнаяСтрока(НСтр("ru = 'Выгрузка <a href = ""Ссылка"">резервных копий</a> в облако Фирмы ""1C"" включена.'"));
	ПараметрыСообщения.Обработчик = "ПояснениеОблачныйАрхивРаботаетОбработкаНавигационнойСсылки";
	ОбщегоНазначения.ВставитьВажноеСообщение(ЭтотОбъект, ПараметрыСообщения, Элементы.ГруппаОблачныйАрхивРаботает);
