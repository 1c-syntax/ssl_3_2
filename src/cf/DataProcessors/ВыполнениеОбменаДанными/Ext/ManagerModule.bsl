...
Процедура ВыполнитьЗапускОбменаДанными(ПараметрыЗадания, АдресХранилища) Экспорт
	...
	ИменаПараметров = "ИдентификаторТранспорта, ВыполнятьЗагрузку, ВыполнятьВыгрузку, ДанныеАутентификации, КлючОбрабатывающегоЗадания";
	ЗаполнитьЗначенияСвойств(ПараметрыОбмена, ПараметрыЗадания, ИменаПараметров);
