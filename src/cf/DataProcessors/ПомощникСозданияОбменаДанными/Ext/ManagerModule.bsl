...
Процедура ПриНачалеЗагрузкиСообщенияОбменаДаннымиСОбновлением(ПараметрыЗагрузки, ПараметрыОбработчика, ПродолжитьОжидание = Ложь) Экспорт
	...
	ПриНачалеЗапускаОбменаДанными(ПараметрыЗагрузки, ПараметрыОбработчика, "ЗагрузитьПриоритетныеДанныеВПодчиненныйУзелРИБВФоне", ПродолжитьОжидание);
...
Процедура ПриНачалеЗагрузкиСообщенияОбменаДаннымиБезОбновленияИБ(ПараметрыЗагрузки, ПараметрыОбработчика, ПродолжитьОжидание = Ложь) Экспорт
	...
	ПриНачалеЗапускаОбменаДанными(ПараметрыЗагрузки, ПараметрыОбработчика, "ЗагрузитьСообщениеПередОбновлениемИнформационнойБазыВФоне", ПродолжитьОжидание);
