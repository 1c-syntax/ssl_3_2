...
Процедура ЗаполнитьТаблицуПереходов()
	...
	Переход.КомандыНавигации        = Элементы.ФормаКомандаВНачало.Имя + "," + Элементы.ФормаПовторитьВМонопольномРежиме.Имя;
...
Функция КомандыПанелиФормы()
	...
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаКомандаВНачало);
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаКомандаГотово);
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаКомандаДалее);
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаПовторитьВМонопольномРежиме);
