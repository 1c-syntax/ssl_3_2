...
Процедура ВариантРаботыПриИзменении(Элемент)
	...
	Если ВариантРаботы < 0 Тогда
		...
		Элементы.ПанельОсновная.ТекущаяСтраница = Элементы.СтраницаТипыТранспортаНачало;
		Элементы.НадписьНачальнаяНастройка.Видимость = Истина;
		Элементы.ВариантРаботы.ОтображениеПодсказки = ОтображениеПодсказки.Нет;
		
		Элементы.ФормаЗагрузитьНастройкиПодключения.Видимость = Ложь;
		Элементы.ФормаГотово.Видимость = Ложь; 
		
	ИначеЕсли ВариантРаботы = 0 Тогда
		
		Элементы.ПанельОсновная.ТекущаяСтраница = Элементы.СтраницаТипыТранспортаНоваяНастройка;		
		Элементы.ВариантРаботы.ОтображениеПодсказки = ОтображениеПодсказки.Кнопка;
		Элементы.ВариантРаботы.Подсказка = НСтр("ru = 'Выполняется начальная настройка синхронизации данных, необходимо выбрать способ доставки сообщений.'");
		Элементы.НадписьНачальнаяНастройка.Видимость = Ложь;
	...
	Иначе
		...
		Элементы.ВариантРаботы.ОтображениеПодсказки = ОтображениеПодсказки.Кнопка;
		Элементы.ВариантРаботы.Подсказка = НСтр("ru = 'Для продолжения настройки выберите тип транспорта и загрузите файл настроек, полученный в базе корреспонденте.'");
		Элементы.НадписьНачальнаяНастройка.Видимость = Ложь;
		
		Элементы.ФормаЗагрузитьНастройкиПодключения.Видимость = Истина;
		Элементы.ФормаГотово.Видимость = Ложь;
