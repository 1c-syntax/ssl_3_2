...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Выборка.Следующий() Тогда
		...
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, Выборка, "ОбластьДанных,КонечнаяТочка,КонечнаяТочкаКорреспондента");
...
Процедура ТаблицаПереходовПоСценарию()
	...
	Переход.КомандыНавигации        = Элементы.ФормаКомандаДалее.Имя;
	...
	Переход.КомандыНавигации          = Элементы.ФормаКомандаНазад.Имя + "," + Элементы.ФормаКомандаДалее.Имя;

	Переход = ТаблицаПереходов.Добавить();
	Переход.ПорядковыйНомерПерехода = 3;
	Переход.ИмяОсновнойСтраницы	 	= "СтраницаОкончание";
	Переход.КомандыНавигации        = Элементы.ФормаКомандаГотово.Имя;
...
Функция КомандыПанелиФормы()
	...
	ЭлементыКомандНавигации.Добавить(Элементы.ФормаКомандаНазад);
