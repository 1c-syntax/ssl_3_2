...
Процедура ПорядковыйНомерПереходаПриИзменении(Знач ЭтоПереходДалее)
	...
	Для Каждого ЭлементКоманднойПанели Из КомандыПанелиФормы() Цикл
...
Процедура ЗаполнитьТаблицуПереходов()
	...
	Переход.КомандыНавигации = "Отмена";
	...
	Переход.КомандыНавигации = "Далее";
	...
	Переход.КомандыНавигации = "Готово";
...
Функция КомандыПанелиФормы()
	...
	ЭлементыКомандНавигации.Добавить(Элементы.Готово);
	ЭлементыКомандНавигации.Добавить(Элементы.Далее);
	ЭлементыКомандНавигации.Добавить(Элементы.Отмена);
