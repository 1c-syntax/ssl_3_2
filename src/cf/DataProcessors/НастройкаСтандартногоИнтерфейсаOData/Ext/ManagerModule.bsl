...
Функция ОбъектыИсключаемыеИзСтандартногоИнтерфейсаOData()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.ВыгрузкаЗагрузкаДанных") Тогда
		МодульВыгрузкаЗагрузкаДанныхСобытияСлужебный = ОбщегоНазначения.ОбщийМодуль("ВыгрузкаЗагрузкаДанныхСобытияСлужебный");
		ИсключаемыеТипыИзВыгрузкиЗагрузки = МодульВыгрузкаЗагрузкаДанныхСобытияСлужебный.ПолучитьТипыИсключаемыеИзВыгрузкиЗагрузки();
