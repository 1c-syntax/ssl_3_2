...
Процедура ЗавершитьСеанс(Команда)
	...
	КоличествоВыделенныхСтрок = Элементы.СписокПользователей.ПолучитьСтрокиДляОбработки().Количество();
	...
	Для Каждого ИдентификаторСтроки Из Элементы.СписокПользователей.ПолучитьСтрокиДляОбработки() Цикл
...
Процедура ОткрытьЖурналРегистрации()
	...
	ВыделенныеСтроки = Элементы.СписокПользователей.ПолучитьСтрокиДляОбработки();
