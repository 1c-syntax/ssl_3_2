...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПрерыватьПриОшибке = Параметры.ПрерыватьПриОшибке Или ИзменятьВТранзакции;
...
Процедура УстановитьЭлементыФормы()
	...
	ПрерыватьПриОшибке = ПрерыватьПриОшибке Или ИзменятьВТранзакции;
	
	Если РежимРазработчика
		Или ОтключитьСвязиПараметровВыбора
		Или ПоказыватьСлужебныеРеквизиты Тогда
		Элементы.СпециальныеВозможности.Показать();
	КонецЕсли;
