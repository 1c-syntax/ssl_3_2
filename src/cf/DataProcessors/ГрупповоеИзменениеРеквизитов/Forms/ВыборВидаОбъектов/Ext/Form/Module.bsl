...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		Элементы.СтрокаПоискаТакси.Видимость = Истина;
		Элементы.ДоступныеОбъектыДляИзменения.ПоложениеСтрокиПоиска = ПоложениеСтрокиПоиска.Нет;
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(Элементы.ДоступныеОбъектыДляИзменения.КоманднаяПанель, КоманднаяПанель);
	КонецЕсли;
...
Процедура ДоступныеОбъектыДляИзмененияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ВыбранныйОбъект = ДоступныеОбъектыДляИзменения.НайтиПоИдентификатору(ВыбраннаяСтрока);
	ВыбранныйОбъект.Пометка = Не ВыбранныйОбъект.Пометка;
	ПодключитьОбработчикОжидания("ОбновитьКоличествоВыбранных", 0.1, Истина);
