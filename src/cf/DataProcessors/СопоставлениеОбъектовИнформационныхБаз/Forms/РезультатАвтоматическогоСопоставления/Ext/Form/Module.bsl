...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НаименованиеЭтойПрограммы   = Параметры.НаименованиеЭтойПрограммы;
	НаименованиеВторойПрограммы = Параметры.НаименованиеВторойПрограммы;
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("ПоказатьВопросПриЗакрытииФормы", ЭтотОбъект), 
		НСтр("ru='Форма содержит данные автоматического сопоставления. Продолжить закрытие формы?'"), 
...
Процедура УстановитьВидимостьПолейТаблицы(Знач ИмяТаблицыФормы, Знач МаксКоличествоПользовательскихПолей)
	...
	Элементы.ТаблицаАвтоматическиСопоставленныхОбъектовПредставлениеИсточника.Заголовок = НаименованиеЭтойПрограммы + ": " + ПредставлениеКолонок;
	Элементы.ТаблицаАвтоматическиСопоставленныхОбъектовПредставлениеПриемника.Заголовок = НаименованиеВторойПрограммы + ": " + ПредставлениеКолонок;
...
Процедура ПослеСопоставленияОбъектов(Знач РезультатСопоставления)
	...
	Для Каждого Строка Из Объект.ТаблицаАвтоматическиСопоставленныхОбъектов Цикл
		...
		Строка.ПредставлениеИсточника = ПредставлениеИсточник;
		Строка.ПредставлениеПриемника = ПредставлениеПриемник;
	КонецЦикла;
...
&НаКлиенте
Процедура ПоказатьВопросПриЗакрытииФормы(Результат, ДополнительныеПараметры) Экспорт
