...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		Элементы.СохранитьКак.Видимость = Ложь;
...
&НаКлиенте
Процедура ЭлектронныеПодписиПередУдалением(Элемент, Отказ)
	Отказ = Истина;
	НачатьУдалениеЭлектронныхПодписей();
КонецПроцедуры

&НаКлиенте
Процедура ЭлектронныеПодписиПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, ЭтоГруппа, Параметр)
	Отказ = Истина;
	НачатьПодписание();
КонецПроцедуры
...
&НаКлиенте
Процедура НачатьУдалениеЭлектронныхПодписей()
	Если ЭтоНовый() Тогда
		Возврат;
	КонецЕсли;
...
&НаСервере
Процедура УдалитьИзСпискаПодписейИЗаписатьФайл(ВыделенныеСтроки)
