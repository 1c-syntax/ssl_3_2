...
Процедура СписокПриНаведении(Элемент, Строка, Поле)
	...
	ОбновитьДоступностьФайловыхКоманд(Строка);
...
Процедура Редактировать(Команда)
	...
	ТекущиеДанные = ТекущиеДанные();
	РедактируетДругоПользователь = ТекущиеДанные.ФайлРедактируется И НЕ ТекущиеДанные.ФайлРедактируетТекущийПользователь;
	Если РедактируетДругоПользователь Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Файл редактирует другой пользователь.'"));
	КонецЕсли;
	
	Если РедактируетДругоПользователь
...
&НаКлиенте
Процедура ОбновитьДоступностьФайловыхКоманд(Строка = Неопределено)
