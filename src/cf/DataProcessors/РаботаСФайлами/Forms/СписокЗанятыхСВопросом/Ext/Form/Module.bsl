...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.Список.Заголовок = Параметры.СообщениеЗаголовок;
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		ПорядокЭлементов = "Да
			|Нет";
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппе(Элементы.КоманднаяПанельТакси, ПорядокЭлементов);
