...
Функция ВыполнитьКопированиеФайла(Знач ИмяФайлаИсточника, Знач ИмяФайлаПриемника)
	...
	Если ОбменДаннымиСлужебный.ПутьКФайлуСодержитНедопустимыеСимволы(ИмяФайлаИсточника)  
		Или ОбменДаннымиСлужебный.ПутьКФайлуСодержитНедопустимыеСимволы(ИмяФайлаПриемника) Тогда
