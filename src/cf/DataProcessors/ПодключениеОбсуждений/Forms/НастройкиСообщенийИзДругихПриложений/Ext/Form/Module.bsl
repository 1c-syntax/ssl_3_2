...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИнтеграцияДоступна Тогда
		...
		Подключение.Логотип = БиблиотекаКартинок.Max16;
	КонецЕсли;
	...
	Если ИнтеграцияДоступна Тогда
		...
		Подключение.Активно = -1;
		Подключение.Тип = ТипВнешнейСистемы;
		Подключение.Логотип = БиблиотекаКартинок.Телеграм16х16;
	КонецЕсли;
	...
	Если ИнтеграцияДоступна Тогда
		...
		Подключение.Активно = -1;
		Подключение.Тип = ТипВнешнейСистемы;
		Подключение.Логотип = БиблиотекаКартинок.ВКонтакте16;
	КонецЕсли;
	...
	Если ИнтеграцияДоступна Тогда
		...
		Подключение.Активно = -1;
		Подключение.Тип = ТипВнешнейСистемы;
		Подключение.Логотип = БиблиотекаКартинок.WhatsApp16;
	КонецЕсли;
	...
	Если ИнтеграцияДоступна Тогда
		...
		Подключение.Активно = -1;
		Подключение.Тип = ТипВнешнейСистемы;
		Подключение.Логотип = БиблиотекаКартинок.WebChat16;
	КонецЕсли;
	...
	Если ИнтеграцияДоступна Тогда
		...
		Подключение.Активно = -1;
		Подключение.Тип = ТипВнешнейСистемы;
		Подключение.Логотип = БиблиотекаКартинок.Webhook16;
	КонецЕсли;
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		Элементы.Переместить(Элементы.ПодменюСоздать, Элементы.СписокПодключений.КоманднаяПанель, Элементы.ФормаОбновить);
		Элементы.СписокПодключенийЛоготип.Ширина = 3;
		Элементы.Переместить(Элементы.ФормаСправка, Элементы.СписокПодключений.КоманднаяПанель);
	КонецЕсли;
