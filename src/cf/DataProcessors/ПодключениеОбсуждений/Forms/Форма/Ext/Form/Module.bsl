...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.РазрешенДоступКИнтернетСервисам() Тогда
		...
		Элементы.ВыборСервераВзаимодействияДиалог.ОтображениеПодсказки = ОтображениеПодсказки.Нет;
	Иначе
		ВыборСервераВзаимодействия = 1;
		Элементы.ВыборСервераВзаимодействияДиалог.Доступность = Ложь;
		Элементы.ВыборСервераВзаимодействияДиалог.ОтображениеПодсказки = ОтображениеПодсказки.ОтображатьСнизу;
...
Процедура ОбновитьВидимостьКнопокКоманднойПанели(Форма)
	...
	ИначеЕсли СостояниеРегистрации = "Зарегистрирована" Тогда
		Форма.Элементы.Зарегистрироваться.Видимость = Истина;
		Форма.Элементы.Зарегистрироваться.Заголовок = НСтр("ru = 'Готово'");
		Форма.Элементы.Назад.Видимость = Ложь;
	КонецЕсли;
...
Процедура ПриИзмененииРазрешенияДоступаКИнтернетСервисам()
	...
	Элементы.ВыборСервераВзаимодействияДиалог.ОтображениеПодсказки = 
		?(Не РазрешенДоступКИнтернетСервисам, ОтображениеПодсказки.ОтображатьСнизу, ОтображениеПодсказки.Нет);
КонецПроцедуры
