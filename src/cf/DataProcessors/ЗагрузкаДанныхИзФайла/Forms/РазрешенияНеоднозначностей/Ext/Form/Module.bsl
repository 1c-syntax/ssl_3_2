...
Процедура ПриОткрытии(Отказ)
	ОпределитьДоступностьКнопкиВыбор();
КонецПроцедуры
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыВариантыВыбора

&НаКлиенте
Процедура ВариантыВыбораПриАктивизацииСтроки(Элемент)
...
Процедура Выбрать(Команда)
	...
	Если Элементы.ВариантыВыбора.ТекущиеДанные <> Неопределено Тогда
		Закрыть(Элементы.ВариантыВыбора.ТекущиеДанные.Ссылка);
	КонецЕсли;
...
&НаКлиенте
Процедура ОпределитьДоступностьКнопкиВыбор()
	
	Элементы.ВариантыВыбораВыбрать.Доступность = Элементы.ВариантыВыбора.ТекущиеДанные <> Неопределено;
