...
Процедура ВыполнитьПеренос(Команда)
	...
	Отказ = Ложь;
	Если (Действие = "ПеренестиМеждуТомами" Или Действие  = "ПеренестиВТома")
	...
	Если (Действие = "ПеренестиМеждуТомами" Или Действие = "ПеренестиВБазу")
		И Не ЗначениеЗаполнено(ТомХраненияИсточник) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(
			НСтр("ru = 'Не заполнен том, из которого будут перенесены файлы.'"), , "ТомХраненияИсточник");
		Отказ = Истина;
	КонецЕсли;
...
Процедура УправлениеЭлементамиФормы()
	...
	Если Действие = "ПеренестиВТома" Тогда
	...
	Элементы.НастройкиИсточника.Видимость = ДоступностьИсточника;
	Элементы.НастройкиПриемника.Видимость = ДоступностьПриемника;
...
Функция ВыполнитьПереносНаСервере()
	...
	ПараметрыПереносаФайлов.ПереноситьВТом = (Действие = "ПеренестиМеждуТомами" Или Действие = "ПеренестиВТома");
...
Функция ФайлыДляПереноса()
	...
	Если Действие = "ПеренестиМеждуТомами" Или Действие = "ПеренестиВТома" Тогда
		ДобавитьНастройкуОтбора(КомпоновщикНастроек, "Том",
			ВидСравненияКомпоновкиДанных.НеРавно, ТомХраненияПриемник);
	КонецЕсли;
	
	Если Действие = "ПеренестиМеждуТомами" Или Действие = "ПеренестиВБазу" Тогда
		ДобавитьНастройкуОтбора(КомпоновщикНастроек, "Том",
