...
Процедура ИнициализироватьВажныеСообщенияНаФорме()
	...
	ПараметрыСообщения.Идентификатор = "ОписаниеФормыПроверкаСервиса";
	ПараметрыСообщения.Сообщение = НСтр("ru = 'В данной форме производится проверка правильности настроек и работоспособности сервиса DSS.
		|Во время проверки могут появляться запросы на пароль, выбор сертификата и подтверждение операций.'");
	ПараметрыСообщения.КраткоеПредставление = НСтр("ru = 'См. справку к форме'");
