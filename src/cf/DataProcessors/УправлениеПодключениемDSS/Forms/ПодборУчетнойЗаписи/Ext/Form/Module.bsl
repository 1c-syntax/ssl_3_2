...
Процедура ИзменитьОформлениеЭлементов()
	...
	Элементы.ФормаПродолжить.Заголовок = ?(ВыборДействия = "Список", НСтр("ru = 'Выбрать'"), НСтр("ru = 'Подтвердить'"));
...
Процедура УстановитьВидимостьДоступность()
	...
	Элементы.ФормаПродолжить.Видимость = НастройкиНовойУчетнойЗаписи Или ВыборНовойУчетнойЗаписи;
	...
	Элементы.ФормаПродолжить.Доступность = Редактируется;
	Элементы.СписокВыборКоманднаяПанель.ТолькоПросмотр = Не Редактируется;
