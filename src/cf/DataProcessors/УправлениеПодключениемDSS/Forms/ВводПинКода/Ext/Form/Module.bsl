...
&НаКлиенте
Процедура ПодтвертитьПароль(Команда)
...
Процедура ПодготовитьФорму(ПараметрыФормы)
	...
	Заголовок = ?(ПараметрыФормы.Свойство("ЗаголовокФормы"),
				ПараметрыФормы.ЗаголовокФормы,
				НСтр("ru = 'Укажите пин-код к закрытому ключу сертификата'", КодЯзыка));
