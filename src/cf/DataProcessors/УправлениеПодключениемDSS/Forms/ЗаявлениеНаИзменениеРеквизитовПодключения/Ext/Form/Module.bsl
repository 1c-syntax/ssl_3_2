...
Процедура НастроитьДоступностьЭлементов()
	...
	Элементы.ГруппаСменаНомераТелефона.Доступность = Изменять И ДоступныКонтакты;
	Элементы.Телефон.Доступность = Режим_СменаКонтактов И Изменять И ДоступныКонтакты;
	
	Элементы.Режим_СменаПароля.Доступность = НЕ Режим_СменаКлючаМобильногоПриложения И Изменять;
	Элементы.Режим_СменаКлючаМобильногоПриложения.Доступность = НЕ Режим_СменаПароля И Изменять
		И НЕ Режим_ПовторнаяОтправкаКлючМобильногоПриложения И НЕ Режим_ПовторнаяОтправкаКодаАктивации;
	Элементы.Режим_ПовторнаяОтправкаКлючМобильногоПриложения.Доступность = НЕ Режим_СменаКлючаМобильногоПриложения И Изменять;
	Элементы.Режим_ПовторнаяОтправкаКодаАктивации.Доступность = НЕ Режим_СменаКлючаМобильногоПриложения И Изменять;
...
Процедура ПодготовитьОформлениеФормы(ДоступныеРазделы)
	...
	Если ЗначениеЗаполнено(ТекущийНомер) Тогда
		Элементы.ГруппаВводНомераТелефонаРасширеннаяПодсказка.Заголовок = НСтр("ru = 'Текущий номер телефона'") + ": " + ТекущийНомер;
	Иначе
		Элементы.ГруппаВводНомераТелефонаРасширеннаяПодсказка.Заголовок = "";
	КонецЕсли;
...
Процедура НастроитьРаботуВТакси()
	...
	ШрифтВТакси = ШрифтыСтиля.ТекстВторогоУровня;
	
	Элементы.ДекорацияРаздела1.Шрифт = ШрифтВТакси;
	Элементы.ДекорацияРаздела2.Шрифт = ШрифтВТакси;
	Элементы.ДекорацияРаздела3.Шрифт = ШрифтВТакси;
	Элементы.ДекорацияРаздела4.Шрифт = ШрифтВТакси;
