...
Процедура СоздатьАкты(Команда)
	...
	Для каждого СтрСписка Из Элементы.СрокиХранения.ПолучитьСтрокиДляОбработки() Цикл
...
&НаКлиенте
Процедура ТолькоСИстекшимСрокомХранения(Команда)
	ПоказыватьТолькоПросроченные = Не ПоказыватьТолькоПросроченные;
	Элементы.СрокиХраненияТолькоСИстекшимСрокомХранения.Пометка = ПоказыватьТолькоПросроченные;
...
Процедура УстановитьВидимостьЭлементов()
	...
	Если РегистрыСведений.СрокиХраненияПерсональныхДанных.ЕстьРассчитанныеСрокиХранения() Тогда
		Элементы.СтраницыГруппа.ТекущаяСтраница = Элементы.СтраницаСрокиХранения;
		Если Документы.АктОбУничтоженииПерсональныхДанных.ЕстьАкты() Тогда
			Элементы.ПустаяСтраница.Видимость = Ложь;
			Элементы.СтраницыГруппа.ОтображениеСтраниц = ОтображениеСтраницФормы.ЗакладкиСверху;
		Иначе
			Элементы.СтраницыГруппа.ОтображениеСтраниц = ОтображениеСтраницФормы.Нет;
