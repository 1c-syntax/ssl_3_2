...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		Ширина = 60;
		Элементы.СообщенияИОписаниеИнформацииОбОшибке.ТолькоПросмотр = Истина;
		Элементы.СообщенияИОписаниеИнформацииОбОшибке.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
	КонецЕсли;
