...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппе(КоманднаяПанель,
			...
			|ЗадачаЗадачаИсполнителяПеренаправить");
	КонецЕсли;
...
Процедура ИнициализироватьФорму()
	...
	Если ПравоДоступа("Изменение", Метаданные.БизнесПроцессы.Задание) Тогда
		...
		Элементы.ФормаВыполнено.Доступность = Не Объект.Выполнена;
		Элементы.ФормаОтклонено.Доступность = Не Объект.Выполнена;
	Иначе
		Элементы.ГруппаКоманднаяПанель.Доступность = Ложь;
		Элементы.ФормаВыполнено.Доступность = Ложь;
		Элементы.ФормаОтклонено.Доступность = Ложь;
	КонецЕсли;
