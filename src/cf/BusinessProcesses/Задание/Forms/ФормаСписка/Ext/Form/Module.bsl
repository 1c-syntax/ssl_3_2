...
Процедура УстановитьОтборСписка(ПараметрыОтбора)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "Завершен", Ложь,, НСтр("ru='Скрыть завершенные'"),
		Не ПараметрыОтбора["ПоказыватьЗавершенныеЗадания"], РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "Остановлен", Ложь,, НСтр("ru='Скрыть остановленные'"),
		Не ПараметрыОтбора["ПоказыватьОстановленные"], РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
