...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка) Экспорт
	...
	Если Параметры.ИмяФормы = "Справочник.Пользователи.Форма.ФормаСписка"
	 ...
	 Или Параметры.ИмяФормы = "Справочник.ГруппыПользователей.Форма.ФормаЭлемента" Тогда
	...
	ИначеЕсли Параметры.ИмяФормы = "Справочник.ВнешниеПользователи.Форма.ФормаСписка"
	      Или Параметры.ИмяФормы = "Справочник.ГруппыВнешнихПользователей.Форма.ФормаСписка"
	...
	Если КлючВарианта = "ИзменениеУчастниковГруппПользователей" Тогда
		Команда.ФункциональныеОпции = "ИспользоватьГруппыПользователей";
		Команда.ТипПараметра = Новый ОписаниеТипов(
			"СправочникСсылка.Пользователи,
			|СправочникСсылка.ГруппыПользователей");
	Иначе
		Команда.ФункциональныеОпции = "ИспользоватьГруппыВнешнихПользователей";
		Команда.ТипПараметра = Новый ОписаниеТипов(
