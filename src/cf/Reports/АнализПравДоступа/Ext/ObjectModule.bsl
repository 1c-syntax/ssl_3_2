...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Форма.Параметры.КлючВарианта = "ПраваПользователейНаТаблицы"
	   И (    Форма.КонтекстВарианта = Метаданные.Справочники.Пользователи.ПолноеИмя()
	      Или Форма.КонтекстВарианта = Метаданные.Справочники.ВнешниеПользователи.ПолноеИмя())
	   И Форма.Параметры.Свойство("ПараметрКоманды")
	   И ТипЗнч(Форма.Параметры.ПараметрКоманды) = Тип("Массив")
	   И Форма.Параметры.ПараметрКоманды.Количество() < 2 Тогда
...
Процедура НастроитьПараметрыКонтекстногоОткрытия(Контекст, Вариант, НастройкиКД, ПользовательскиеНастройкиКД)
	...
	ИначеЕсли Вариант = "ПраваПользователейНаТаблицы" Или Вариант = "ПраваПользователяНаТаблицы" Тогда
		Если Контекст.Параметры.Свойство("ПараметрКоманды") Тогда
			...
			СписокПользователей.ЗагрузитьЗначения(Значения);
