...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка) Экспорт
	...
	Если Параметры.ИмяФормы <> "Справочник.Пользователи.Форма.ФормаСписка"
	   ...
	   И Параметры.ИмяФормы <> "Справочник.ГруппыПользователей.Форма.ФормаСписка"
	   И Параметры.ИмяФормы <> "Справочник.ГруппыПользователей.Форма.ФормаЭлемента"
	   ...
	   И Параметры.ИмяФормы <> "Справочник.ГруппыВнешнихПользователей.Форма.ФормаСписка"
	   И Параметры.ИмяФормы <> "Справочник.ГруппыВнешнихПользователей.Форма.ФормаЭлемента"
