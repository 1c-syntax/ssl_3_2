...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.КлассификаторКонтекстноеМенюОткрытьДанныеПоСтране.Видимость = ПравоДоступа("Изменение", Метаданные.Справочники.СтраныМира);
	
	ЕстьПравоРедактироватьСтраны = ПравоДоступа("Изменение", Метаданные.Справочники.СтраныМира);
	Элементы.КлассификаторКонтекстноеМенюОткрытьДанныеПоСтране.Видимость = ЕстьПравоРедактироватьСтраны;
	Элементы.КлассификаторОткрытьДанныеПоСтране.Видимость = ЕстьПравоРедактироватьСтраны;
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(Элементы.Классификатор.КоманднаяПанель, КоманднаяПанель);
	КонецЕсли;
...
&НаКлиенте
Процедура ОткрытьДанныеПоСтране(Команда)
