...
Процедура ПриОткрытии(Отказ)
	...
	Если ОткрытьФормуКлассификатора Тогда
		...
		ПоказатьКлассификатор(ПараметрыОткрытия, ВладелецФормы, РежимБлокировкиПриОткрытииОкна);
		Отказ = Истина;
	КонецЕсли;
...
&НаКлиенте
Процедура ПоказатьКлассификатор(ПараметрыОткрытия, ВладелецФормы, РежимБлокировкиПриОткрытииОкна = Неопределено);
	...
	МодульРаботаСАдресамиКлиент.ПоказатьКлассификатор(ПараметрыОткрытия, ВладелецФормы, РежимБлокировкиПриОткрытииОкна);
