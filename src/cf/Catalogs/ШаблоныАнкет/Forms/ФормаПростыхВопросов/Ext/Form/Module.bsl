...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипСтрокиДерева = "Раздел" Тогда
		...
		Элементы.ПризнакОбязательный.Видимость        = Ложь;
		Элементы.ФормулировкаОтказаОтОтвета.Видимость = Ложь;
		Элементы.ЭлементарныйВопрос.Видимость         = Ложь;
		Элементы.Подсказка.Видимость                  = Ложь;
		Элементы.СпособОтображенияПодсказки.Видимость = Ложь;
	...
	Если Не Параметры.ЭтоНоваяСтрока Тогда
		Элементы.КнопкаДобавить.Заголовок = НСтр("ru = 'Применить'");
	КонецЕсли;
	
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		Элементы.Закрыть.Видимость = Истина;
		Элементы.ПризнакОбязательный.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
		Элементы.СпособОтображенияПодсказки.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
	КонецЕсли;
