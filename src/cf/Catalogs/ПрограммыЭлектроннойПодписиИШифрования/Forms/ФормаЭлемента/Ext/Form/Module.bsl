...
Процедура УстановитьЗаголовокАвтоматическиеНастройки(ПоставляемаяНастройка)
	...
	Если ПоставляемаяНастройка = Неопределено Тогда
		АлгоритмПодписи = НСтр("ru = 'Не определен автоматически'");
		АлгоритмШифрования = НСтр("ru = 'Не определен автоматически'");
		АлгоритмХеширования = НСтр("ru = 'Не определен автоматически'");
		
		Возврат;
	КонецЕсли;
	
	АлгоритмПодписи = ПоставляемаяНастройка.АлгоритмПодписи;
	АлгоритмШифрования = ПоставляемаяНастройка.АлгоритмШифрования;
	АлгоритмХеширования = ПоставляемаяНастройка.АлгоритмХеширования;
КонецПроцедуры
...
Процедура УстановитьВидимостьИДоступность(Форма)
	...
	Форма.Элементы.ГруппаАвтоматическиеАлгоритмы.Видимость = Не ДоступностьНастроек;
	Форма.Элементы.ГруппаАлгоритмы.Видимость = ДоступностьНастроек;
	Форма.Элементы.Наименование.ТолькоПросмотр = Не ДоступностьНастроек;
	Форма.Элементы.ИмяПрограммы.ТолькоПросмотр = Не ДоступностьНастроек;
	Форма.Элементы.ТипПрограммы.ТолькоПросмотр = Не ДоступностьНастроек;
