...
Процедура ИспользоватьПоУмолчанию(Команда)
	...
	Для Каждого Строка Из ТипыТранспорта Цикл
		...
		Если Строка.ИдентификаторТранспорта = ИдентификаторТранспорта Тогда
			Строка.КартинкаФлаг = БиблиотекаКартинок.Избранное;
...
Процедура УстановитьУсловноеОформление()
	...
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных("ТипыТранспортаКартинкаФлаг");
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Картинка", БиблиотекаКартинок.НастройкаЗаполнена);
