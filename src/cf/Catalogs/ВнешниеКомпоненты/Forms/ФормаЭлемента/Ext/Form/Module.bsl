...
Процедура УстановитьВидимостьДоступность()
	...
	Если ЗначениеЗаполнено(Объект.ОписаниеОшибки) Тогда
		ПоказатьВажноеСообщение(Объект.ОписаниеОшибки);
	Иначе
		ОбщегоНазначенияКлиентСервер.УдалитьСтатусИлиВажноеСообщение(ЭтотОбъект, "ВнешниеКомпонентыИнформация");
	КонецЕсли;
...
&НаСервере
Процедура ПоказатьВажноеСообщение(Сообщение)
	...
	ПараметрыСообщения.Идентификатор = "ВнешниеКомпонентыИнформация";
