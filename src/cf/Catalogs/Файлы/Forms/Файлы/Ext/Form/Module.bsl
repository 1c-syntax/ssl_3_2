...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		...
		Если ЭлементФормыСуществует(ЭтотОбъект, "ПапкиСоздать") Тогда
...
Процедура УстановитьДоступностьКомандПапокПриИзмененииПапки()
	...
	Если ЭлементФормыСуществует(ЭтотОбъект, "ПапкиСоздать") Тогда
		Элементы.ПапкиСоздать.Доступность = ИзменениеПапок И РазрешеноРедактирование;
		Элементы.ПапкиКонтекстноеМенюСоздать.Доступность = Элементы.ПапкиСоздать.Доступность;
	КонецЕсли;
...
Процедура УстановитьДоступностьКомандСпискаПриИзмененииПапки()
	...
	Если ЭлементФормыСуществует(ЭтотОбъект, "СписокСоздать") Тогда
		Элементы.СписокСоздать.Доступность = РазрешеноДобавление;
		Элементы.СписокКонтекстноеМенюСоздать.Доступность = Элементы.СписокСоздать.Доступность;
	КонецЕсли;
