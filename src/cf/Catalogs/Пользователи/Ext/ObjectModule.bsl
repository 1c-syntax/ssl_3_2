...
Перем ЭтоНовый, ГруппаНовогоПользователя;
...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ОбменДанными.Загрузка
	   И ДополнительныеСвойства.Свойство("ГруппаНовогоПользователя")
	   И ЗначениеЗаполнено(ДополнительныеСвойства.ГруппаНовогоПользователя) Тогда
		
		ГруппаНовогоПользователя = ДополнительныеСвойства.ГруппаНовогоПользователя;
		
		Блокировка = Новый БлокировкаДанных;
		ЭлементБлокировки = Блокировка.Добавить("Справочник.ГруппыПользователей");
		ЭлементБлокировки.УстановитьЗначение("Ссылка", ГруппаНовогоПользователя);
...
Процедура ПриЗаписи(Отказ)
	...
	Если ГруппаНовогоПользователя <> Неопределено Тогда
