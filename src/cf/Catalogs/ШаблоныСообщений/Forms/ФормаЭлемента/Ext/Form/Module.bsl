...
&НаКлиенте
Процедура ПолноеИмяТипаПараметраВводаНаОснованииОбработкаВыбора(Элемент, ВыбранноеЗначение, ДополнительныеДанные, ВыборДобавлением, СтандартнаяОбработка)
...
Процедура РеквизитыНачалоПеретаскивания(Элемент, ПараметрыПеретаскивания, Выполнение)
	...
	ПеретаскиваемыйОбъект = ПараметрыПеретаскивания.Значение;
	ТекстДляВставки       = "";
	Разделитель           = "";
...
Функция ПолучитьТипПоПолномуИмени(Знач ПолноеИмя)
	...
	Если ОбъектМетаданных <> Неопределено Тогда
		...
		Если МенеджерОбъекта <> Неопределено Тогда
			Возврат ТипЗнч(МенеджерОбъекта.ПустаяСсылка());
		КонецЕсли;
	КонецЕсли;
