...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппу(КоманднаяПанель,
		Элементы.ГруппыДоступа.КоманднаяПанель);
	...
	СтандартныеПодсистемыСервер.ПереместитьЭлементыВГруппе(
		Элементы.ГруппыДоступа.КоманднаяПанель, "ФормаВыбрать");
...
&НаКлиенте
Процедура ГруппыДоступаВыборЗначения(Элемент, Значение, СтандартнаяОбработка)
