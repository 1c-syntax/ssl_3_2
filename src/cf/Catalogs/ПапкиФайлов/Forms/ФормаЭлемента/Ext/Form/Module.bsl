...
Процедура ОбновитьПояснениеОблачногоСервиса()
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьСинхронизациюФайлов") Тогда
		Возврат;
	КонецЕсли;
	...
	ПараметрыСообщения.Идентификатор = "РаботаСФайламиОблачныйСервис";
	ПараметрыСообщения.КраткоеПредставление = НСтр("ru = 'Работа в облачном сервисе'");
