...
Функция ПредставлениеАдреса(УчетнаяЗапись) Экспорт
	
	ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(УчетнаяЗапись,
		"ИмяПользователя, АдресЭлектроннойПочты");
	
	Возврат РаботаСПочтовымиСообщениямиСлужебныйКлиентСервер.ПредставлениеАдреса(
		ЗначенияРеквизитов.АдресЭлектроннойПочты, ЗначенияРеквизитов.ИмяПользователя);
