...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоВариантИнтерфейса85() Тогда
		ЭтотОбъект.ПоложениеКоманднойПанели = ПоложениеКоманднойПанелиФормы.Низ;
	КонецЕсли;
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Элементы.Страницы.ТекущаяСтраница = Элементы.ТехническиеПодробности Тогда
		СкрытьТехническиеПодробности();
		Отказ = Истина;
	КонецЕсли;
...
&НаКлиенте
Процедура ГиперссылкаСвернутьПодробностиНажатие(Элемент)
...
&НаКлиенте
Процедура СкрытьТехническиеПодробности()
	
	Элементы.Страницы.ТекущаяСтраница = Элементы.ПриПроверкеОбнаруженыОшибки;
	Элементы.ГруппаПодвал.Видимость = Истина;
	Элементы.ФормаПерейтиКНастройкам.Видимость = Истина;
