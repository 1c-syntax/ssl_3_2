...
Процедура ПриЗаписи(Отказ)
	...
	Если ДополнительныеСвойства.Свойство("ИзмененияСоставов") Тогда
		ОбработатьИзмененияСоставов = Ложь;
		ИзмененияСоставов = ДополнительныеСвойства.ИзмененияСоставов;
	Иначе
		ОбработатьИзмененияСоставов = Истина;
	...
	Если ОбработатьИзмененияСоставов Тогда
		ПользователиСлужебный.ПослеЗаписиГруппыПользователей(ЭтотОбъект, ЭтоНовый, ИзмененияСоставов);
	КонецЕсли;
