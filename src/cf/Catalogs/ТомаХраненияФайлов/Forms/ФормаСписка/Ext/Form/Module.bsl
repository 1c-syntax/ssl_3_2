...
Процедура ПроверитьЦелостность(Команда)
	...
	Если Не ЭтоТомХраненияНаДисках(ТекущиеДанные.Ссылка) Тогда
...
Процедура НастроитьХранилищаДвоичныхДанных(Команда)
	...
	ОткрытьФорму("Обработка.УправлениеХранилищемДвоичныхДанных.Форма.СписокХранилищ", , ЭтотОбъект,,,,,РежимБлокировкиПриОткрытииОкнаФормы.БлокироватьВесьИнтерфейс);
