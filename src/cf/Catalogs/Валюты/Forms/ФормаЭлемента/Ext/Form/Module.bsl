...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ПараметрыПрописиВалюты.Видимость = ФормыВводаПрописей.Количество() = 1;
	...
	Элементы.КурсВалютыЗагружаетсяИзИнтернета.Видимость = ДоступнаЗагрузкаИзИнтернета;
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если Источник = ЭтотОбъект И ИмяСобытия = "ПараметрыПрописиВалюты" И Не ТолькоПросмотр Тогда
...
&НаКлиенте
Процедура ПараметрыПрописиВалюты(Команда)
...
Процедура УстановитьДоступностьЭлементов(Форма)
	...
	Если Объект.СпособУстановкиКурса = ПредопределенноеЗначение(
	   "Перечисление.СпособыУстановкиКурсаВалюты.НаценкаНаКурсДругойВалюты") Тогда
		
		Элементы.ГруппаНастройкиКурса.ТекущаяСтраница = Элементы.ГруппаНаценкаНаКурсДругойВалюты;
	
	ИначеЕсли Объект.СпособУстановкиКурса = ПредопределенноеЗначение(
	   "Перечисление.СпособыУстановкиКурсаВалюты.РасчетПоФормуле") Тогда
		
		Элементы.ГруппаНастройкиКурса.ТекущаяСтраница = Элементы.ГруппаРасчетПоФормуле;
		
	Иначе
		Элементы.ГруппаНастройкиКурса.ТекущаяСтраница = Элементы.ГруппаБезНастроек;
	КонецЕсли;
