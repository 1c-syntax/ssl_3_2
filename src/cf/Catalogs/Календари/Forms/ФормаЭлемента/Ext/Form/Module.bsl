...
Процедура РезультатЗаполнения(Команда)
	...
	Если Элементы.Страницы.ТекущаяСтраница = Элементы.НастройкаЗаполненияСтраница Тогда
		Элементы.Страницы.ТекущаяСтраница = Элементы.РезультатЗаполненияСтраница;
		Элементы.РезультатЗаполнения.Заголовок = НСтр("ru = 'Настройка заполнения'");
	...
	Иначе
		...
		Элементы.РезультатЗаполнения.Заголовок = НСтр("ru = 'Результат заполнения'");
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаПалитры.Серый);
...
Процедура УстановитьСнятьПризнакРучногоРедактирования(Форма, РучноеРедактирование)
	...
	ОбновитьФонБаннера(Форма);
	
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура ОбновитьФонБаннера(Форма)
	
	Если Форма.РучноеРедактирование Или Не Форма.РезультатЗаполненПоШаблону Тогда
		Форма.Элементы.РезультатЗаполненияИнформационныйТекстГруппа.ЦветФона = Форма.Элементы.ПалитраОранжевый.ЦветФона;
	Иначе
		Форма.Элементы.РезультатЗаполненияИнформационныйТекстГруппа.ЦветФона = Форма.Элементы.ПалитраГолубой.ЦветФона;
	КонецЕсли;
...
Процедура ЗаполнитьИнформационныйТекстРезультатаЗаполнения(Форма)
	...
	Форма.Элементы.ДекорацияРезультатЗаполнения.Заголовок = ИнформационныйТекст;
...
Процедура ЗаполнитьИнформационныйТекстРучногоРедактирования(Форма)
	...
	Форма.Элементы.ГодыРучногоРедактированияГруппа.Видимость = Форма.РучноеРедактирование
