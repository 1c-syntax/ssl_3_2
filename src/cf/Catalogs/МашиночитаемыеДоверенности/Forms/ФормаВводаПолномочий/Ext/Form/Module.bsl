...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ПолномочияПодменюВидПолномочий.Видимость  = Не ЭтоВыборИзКлассификатора И Не Параметры.ТолькоПросмотр И Не ЭтоПередоверие;
	Элементы.ВыбранныеПолномочияТаблицаПодменюВидПолномочий.Видимость = Элементы.ПолномочияПодменюВидПолномочий.Видимость;
	Элементы.ПодменюВыборВидаПолномочий.Видимость = Элементы.ПолномочияПодменюВидПолномочий.Видимость;
...
Процедура УправлениеФормой(Форма)
	...
	Иначе
		ЗаголовокВидаПолномочий = НСтр("ru='Вид полномочий'");
	КонецЕсли;
	
	Если Форма.ВидПолномочий = "1" Или Форма.ВидПолномочий = "2" Тогда
		Форма.Элементы.ПодменюВыборВидаПолномочий.Заголовок = ЗаголовокВидаПолномочий;
	...
	Иначе
		Форма.Элементы.ПолномочияПодменюВидПолномочий.Заголовок  = ЗаголовокВидаПолномочий;
		Форма.Элементы.ВыбранныеПолномочияТаблицаПодменюВидПолномочий.Заголовок = ЗаголовокВидаПолномочий;
