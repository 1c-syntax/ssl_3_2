...
Процедура ПрочитатьПользовательскиеНастройки()
	...
	Если ТекущиеПользовательскиеНастройки = Неопределено Тогда 
		Элементы.ПерсональныеНастройки.ОтображатьКоманднуюПанель = Ложь;
...
Процедура УпаковатьНастройкиВариантаОтчета(ОписаниеВариантаОтчета)
	...
	Архив = Новый ЗаписьФайлаАрхива(ИмяФайлаАрхива);
...
//
// Параметры:
//  Архив - ЗаписьФайлаАрхива - архив, в который упаковываются настройки варианта отчета и их описание.
