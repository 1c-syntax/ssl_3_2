...
Процедура СтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	УстановитьВидимостьКнопок(ЭтотОбъект);
КонецПроцедуры
...
Процедура ПослеЗаполненияЗначений(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Статус = "Ошибка" Тогда
		...
		ВывестиВажноеСообщениеОбОшибкеЗаполненияЗначений(Результат.КраткоеПредставлениеОшибки);
...
&НаСервере
Процедура ВывестиВажноеСообщениеОбОшибкеЗаполненияЗначений(ТекстОшибки)
	...
	ПараметрыВажногоСообщения.Идентификатор = "ОшибкаЗаполнения";
	ПараметрыВажногоСообщения.Заголовок = НСтр("ru = 'Не удалось заполнить фильтр по значению по причине:'");
	ПараметрыВажногоСообщения.Сообщение = ТекстОшибки;
	ПараметрыВажногоСообщения.КраткоеПредставление = НСтр("ru = 'Не удалось заполнить фильтр по значению'");
	ПараметрыВажногоСообщения.Скрываемый = Ложь;
	ОбщегоНазначения.ВставитьВажноеСообщение(ЭтотОбъект, ПараметрыВажногоСообщения, Элементы.ОшибкаЗаполнения);
...
&НаКлиентеНаСервереБезКонтекста
 Процедура УстановитьВидимостьКнопок(Форма)
	
	ТекущаяСтраница = Форма.Элементы.Страницы.ТекущаяСтраница;
	Форма.Элементы.Применить.Видимость = ТекущаяСтраница = Форма.Элементы.Фильтры;
	Форма.Элементы.ПрименитьИСформировать.Видимость = ТекущаяСтраница = Форма.Элементы.Фильтры;
	Форма.Элементы.ОформитьЕще.Видимость = ТекущаяСтраница = Форма.Элементы.БыстрыеНастройки;
