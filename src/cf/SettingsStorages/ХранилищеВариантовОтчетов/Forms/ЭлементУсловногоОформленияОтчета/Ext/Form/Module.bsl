...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РежимОтображения = Параметры.НомерКартинкиРежимаОтображения;
	Если Параметры.НомерКартинкиРежимаОтображения = 0 Тогда
...
Процедура ВыбратьИЗакрыть()
	...
	Результат.Вставить("НомерКартинкиРежимаОтображения", РежимОтображения);
...
Процедура ПрименитьВариантВыбораОформляемогоПоля(Форма, ЭлементОформления = Неопределено, ИспользуемыеПоля = Неопределено)
	...
	Если Вариант = Варианты[0].Значение Тогда 
		...
		ЭлементыФормы.ОформляемоеПоле.Видимость = Ложь;
	...
	ИначеЕсли Вариант = Варианты[1].Значение Тогда 
		...
		ЭлементыФормы.ОформляемоеПоле.Видимость = Истина;
		ЭлементыФормы.ОформляемыеПоля.Видимость = Ложь;
