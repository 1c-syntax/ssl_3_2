...
Процедура ЗаполнитьПанельОтчетов()
	...
	Если Не ЕстьДругиеОтчеты Тогда
		...
		ПараметрыВажногоСообщения.Идентификатор = "ДругихОтчетовНет";
		ПараметрыВажногоСообщения.Сообщение = НСтр("ru = 'Других отчетов нет'");
		ПараметрыВажногоСообщения.КраткоеПредставление = НСтр("ru = 'Других отчетов нет'");
